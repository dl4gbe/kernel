...
{
	return array('uid','sid','ssid','hostname','timestamp','cache','session','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select uid as ' . $delimiter . 'drupal_sessions.uid' . $delimiter . ',sid as ' . $delimiter . 'drupal_sessions.sid' . $delimiter . ',ssid as ' . $delimiter . 'drupal_sessions.ssid' . $delimiter . ',hostname as ' . $delimiter . 'drupal_sessions.hostname' . $delimiter . ',timestamp as ' . $delimiter . 'drupal_sessions.timestamp' . $delimiter . ',cache as ' . $delimiter . 'drupal_sessions.cache' . $delimiter . ',session as ' . $delimiter . 'drupal_sessions.session' . $delimiter . ',id as ' . $delimiter . 'drupal_sessions.id' . $delimiter . ' from drupal_sessions';
}
