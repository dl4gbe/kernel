...
{
	return array('one_to_many','alias','remark','activ','child_table_field','table_name_child','parent_table_field','table_name_parent','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select one_to_many as ' . $delimiter . 'table_relation.one_to_many' . $delimiter . ',alias as ' . $delimiter . 'table_relation.alias' . $delimiter . ',remark as ' . $delimiter . 'table_relation.remark' . $delimiter . ',activ as ' . $delimiter . 'table_relation.activ' . $delimiter . ',child_table_field as ' . $delimiter . 'table_relation.child_table_field' . $delimiter . ',table_name_child as ' . $delimiter . 'table_relation.table_name_child' . $delimiter . ',parent_table_field as ' . $delimiter . 'table_relation.parent_table_field' . $delimiter . ',table_name_parent as ' . $delimiter . 'table_relation.table_name_parent' . $delimiter . ',id as ' . $delimiter . 'table_relation.id' . $delimiter . ' from table_relation';
}
