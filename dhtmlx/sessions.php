...
require_once('include/data/tables/cls_table_sessions.php');
require_once('table_helpers/cls_sessions_helpers.php');
$app = new cls_application();
$get_parameter = new cls_get_parameter();
$helper = new cls_sessions_helpers($app->get_db_manager(),$app);
