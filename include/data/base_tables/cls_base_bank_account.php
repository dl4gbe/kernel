...
{
	return array('holder','bic','iban','accountno','bankcode','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select holder as ' . $delimiter . 'bank_account.holder' . $delimiter . ',bic as ' . $delimiter . 'bank_account.bic' . $delimiter . ',iban as ' . $delimiter . 'bank_account.iban' . $delimiter . ',accountno as ' . $delimiter . 'bank_account.accountno' . $delimiter . ',bankcode as ' . $delimiter . 'bank_account.bankcode' . $delimiter . ',id as ' . $delimiter . 'bank_account.id' . $delimiter . ' from bank_account';
}
