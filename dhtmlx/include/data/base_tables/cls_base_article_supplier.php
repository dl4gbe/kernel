...
{
	return array('id','id_article','id_person_supplier','name','orderno','mindeliverytimedays','mininimumorderqty');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'article_supplier.id' . $delimiter . ',id_article as ' . $delimiter . 'article_supplier.id_article' . $delimiter . ',id_person_supplier as ' . $delimiter . 'article_supplier.id_person_supplier' . $delimiter . ',name as ' . $delimiter . 'article_supplier.name' . $delimiter . ',orderno as ' . $delimiter . 'article_supplier.orderno' . $delimiter . ',mindeliverytimedays as ' . $delimiter . 'article_supplier.mindeliverytimedays' . $delimiter . ',mininimumorderqty as ' . $delimiter . 'article_supplier.mininimumorderqty' . $delimiter . ' from article_supplier';
}
