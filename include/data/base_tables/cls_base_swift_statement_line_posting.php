...
{
	return array('remark','link_date','id_person_employee_linked','id_swift_statement_line','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select remark as ' . $delimiter . 'swift_statement_line_posting.remark' . $delimiter . ',link_date as ' . $delimiter . 'swift_statement_line_posting.link_date' . $delimiter . ',id_person_employee_linked as ' . $delimiter . 'swift_statement_line_posting.id_person_employee_linked' . $delimiter . ',id_swift_statement_line as ' . $delimiter . 'swift_statement_line_posting.id_swift_statement_line' . $delimiter . ',id as ' . $delimiter . 'swift_statement_line_posting.id' . $delimiter . ' from swift_statement_line_posting';
}
