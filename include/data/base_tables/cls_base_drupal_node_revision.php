...
{
	return array('id','sticky','promote','comment','status','timestamp','log','title','uid','vid','nid');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'drupal_node_revision.id' . $delimiter . ',sticky as ' . $delimiter . 'drupal_node_revision.sticky' . $delimiter . ',promote as ' . $delimiter . 'drupal_node_revision.promote' . $delimiter . ',comment as ' . $delimiter . 'drupal_node_revision.comment' . $delimiter . ',status as ' . $delimiter . 'drupal_node_revision.status' . $delimiter . ',timestamp as ' . $delimiter . 'drupal_node_revision.timestamp' . $delimiter . ',log as ' . $delimiter . 'drupal_node_revision.log' . $delimiter . ',title as ' . $delimiter . 'drupal_node_revision.title' . $delimiter . ',uid as ' . $delimiter . 'drupal_node_revision.uid' . $delimiter . ',vid as ' . $delimiter . 'drupal_node_revision.vid' . $delimiter . ',nid as ' . $delimiter . 'drupal_node_revision.nid' . $delimiter . ' from drupal_node_revision';
}
