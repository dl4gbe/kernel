...
{
	return array('id_account_depreciation','id_account_asset','id_chart_of_account','id_fixed_asset_group','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select id_account_depreciation as ' . $delimiter . 'fixed_asset_group_account.id_account_depreciation' . $delimiter . ',id_account_asset as ' . $delimiter . 'fixed_asset_group_account.id_account_asset' . $delimiter . ',id_chart_of_account as ' . $delimiter . 'fixed_asset_group_account.id_chart_of_account' . $delimiter . ',id_fixed_asset_group as ' . $delimiter . 'fixed_asset_group_account.id_fixed_asset_group' . $delimiter . ',id as ' . $delimiter . 'fixed_asset_group_account.id' . $delimiter . ' from fixed_asset_group_account';
}
