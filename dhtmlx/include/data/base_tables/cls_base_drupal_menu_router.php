...
{
	return array('path','load_functions','to_arg_functions','access_callback','access_arguments','page_callback','page_arguments','delivery_callback','fit','number_parts','context','tab_parent','tab_root','title','title_callback','title_arguments','theme_callback','theme_arguments','type','description','position','weight','include_file','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select path as ' . $delimiter . 'drupal_menu_router.path' . $delimiter . ',load_functions as ' . $delimiter . 'drupal_menu_router.load_functions' . $delimiter . ',to_arg_functions as ' . $delimiter . 'drupal_menu_router.to_arg_functions' . $delimiter . ',access_callback as ' . $delimiter . 'drupal_menu_router.access_callback' . $delimiter . ',access_arguments as ' . $delimiter . 'drupal_menu_router.access_arguments' . $delimiter . ',page_callback as ' . $delimiter . 'drupal_menu_router.page_callback' . $delimiter . ',page_arguments as ' . $delimiter . 'drupal_menu_router.page_arguments' . $delimiter . ',delivery_callback as ' . $delimiter . 'drupal_menu_router.delivery_callback' . $delimiter . ',fit as ' . $delimiter . 'drupal_menu_router.fit' . $delimiter . ',number_parts as ' . $delimiter . 'drupal_menu_router.number_parts' . $delimiter . ',context as ' . $delimiter . 'drupal_menu_router.context' . $delimiter . ',tab_parent as ' . $delimiter . 'drupal_menu_router.tab_parent' . $delimiter . ',tab_root as ' . $delimiter . 'drupal_menu_router.tab_root' . $delimiter . ',title as ' . $delimiter . 'drupal_menu_router.title' . $delimiter . ',title_callback as ' . $delimiter . 'drupal_menu_router.title_callback' . $delimiter . ',title_arguments as ' . $delimiter . 'drupal_menu_router.title_arguments' . $delimiter . ',theme_callback as ' . $delimiter . 'drupal_menu_router.theme_callback' . $delimiter . ',theme_arguments as ' . $delimiter . 'drupal_menu_router.theme_arguments' . $delimiter . ',type as ' . $delimiter . 'drupal_menu_router.type' . $delimiter . ',description as ' . $delimiter . 'drupal_menu_router.description' . $delimiter . ',position as ' . $delimiter . 'drupal_menu_router.position' . $delimiter . ',weight as ' . $delimiter . 'drupal_menu_router.weight' . $delimiter . ',include_file as ' . $delimiter . 'drupal_menu_router.include_file' . $delimiter . ',id as ' . $delimiter . 'drupal_menu_router.id' . $delimiter . ' from drupal_menu_router';
}
