...
{
	return array('id','id_data','address1','address2','zip','city','id_country','main','id_address_type','lat','lon','open_geo_db_id');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'address.id' . $delimiter . ',id_data as ' . $delimiter . 'address.id_data' . $delimiter . ',address1 as ' . $delimiter . 'address.address1' . $delimiter . ',address2 as ' . $delimiter . 'address.address2' . $delimiter . ',zip as ' . $delimiter . 'address.zip' . $delimiter . ',city as ' . $delimiter . 'address.city' . $delimiter . ',id_country as ' . $delimiter . 'address.id_country' . $delimiter . ',main as ' . $delimiter . 'address.main' . $delimiter . ',id_address_type as ' . $delimiter . 'address.id_address_type' . $delimiter . ',lat as ' . $delimiter . 'address.lat' . $delimiter . ',lon as ' . $delimiter . 'address.lon' . $delimiter . ',open_geo_db_id as ' . $delimiter . 'address.open_geo_db_id' . $delimiter . ' from address';
}
