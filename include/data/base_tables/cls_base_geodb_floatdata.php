...
{
	return array('date_type_until','valid_until','date_type_since','valid_since','float_val','float_type','loc_id');
}

public function get_table_select($delimiter = '"')
{
	return 'select date_type_until as ' . $delimiter . 'geodb_floatdata.date_type_until' . $delimiter . ',valid_until as ' . $delimiter . 'geodb_floatdata.valid_until' . $delimiter . ',date_type_since as ' . $delimiter . 'geodb_floatdata.date_type_since' . $delimiter . ',valid_since as ' . $delimiter . 'geodb_floatdata.valid_since' . $delimiter . ',float_val as ' . $delimiter . 'geodb_floatdata.float_val' . $delimiter . ',float_type as ' . $delimiter . 'geodb_floatdata.float_type' . $delimiter . ',loc_id as ' . $delimiter . 'geodb_floatdata.loc_id' . $delimiter . ' from geodb_floatdata';
}
