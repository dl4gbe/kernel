...
{
	return array('id','table_name','name','path','source','activ');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'table_search_template.id' . $delimiter . ',table_name as ' . $delimiter . 'table_search_template.table_name' . $delimiter . ',name as ' . $delimiter . 'table_search_template.name' . $delimiter . ',path as ' . $delimiter . 'table_search_template.path' . $delimiter . ',source as ' . $delimiter . 'table_search_template.source' . $delimiter . ',activ as ' . $delimiter . 'table_search_template.activ' . $delimiter . ' from table_search_template';
}
