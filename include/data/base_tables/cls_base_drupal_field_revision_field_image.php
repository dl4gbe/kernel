...
{
	return 'select id as ' . $delimiter . 'drupal_field_revision_field_image.id' . $delimiter . ',field_image_height as ' . $delimiter . 'drupal_field_revision_field_image.field_image_height' . $delimiter . ',field_image_width as ' . $delimiter . 'drupal_field_revision_field_image.field_image_width' . $delimiter . ',field_image_title as ' . $delimiter . 'drupal_field_revision_field_image.field_image_title' . $delimiter . ',field_image_alt as ' . $delimiter . 'drupal_field_revision_field_image.field_image_alt' . $delimiter . ',field_image_fid as ' . $delimiter . 'drupal_field_revision_field_image.field_image_fid' . $delimiter . ',delta as ' . $delimiter . 'drupal_field_revision_field_image.delta' . $delimiter . ',language as ' . $delimiter . 'drupal_field_revision_field_image.language' . $delimiter . ',revision_id as ' . $delimiter . 'drupal_field_revision_field_image.revision_id' . $delimiter . ',entity_id as ' . $delimiter . 'drupal_field_revision_field_image.entity_id' . $delimiter . ',deleted as ' . $delimiter . 'drupal_field_revision_field_image.deleted' . $delimiter . ',bundle as ' . $delimiter . 'drupal_field_revision_field_image.bundle' . $delimiter . ',entity_type as ' . $delimiter . 'drupal_field_revision_field_image.entity_type' . $delimiter . ' from drupal_field_revision_field_image';
}
