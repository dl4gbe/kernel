...
{
	return array('id','name','file_name','table_name','caption','id_ribbonbar','has_edit_form','id_control_detail');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'data_view.id' . $delimiter . ',name as ' . $delimiter . 'data_view.name' . $delimiter . ',file_name as ' . $delimiter . 'data_view.file_name' . $delimiter . ',table_name as ' . $delimiter . 'data_view.table_name' . $delimiter . ',caption as ' . $delimiter . 'data_view.caption' . $delimiter . ',id_ribbonbar as ' . $delimiter . 'data_view.id_ribbonbar' . $delimiter . ',has_edit_form as ' . $delimiter . 'data_view.has_edit_form' . $delimiter . ',id_control_detail as ' . $delimiter . 'data_view.id_control_detail' . $delimiter . ' from data_view';
}
