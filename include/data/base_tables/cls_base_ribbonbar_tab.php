...
{
	return array('tab_order','active','imagepath','name','id_ribbonbar','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select tab_order as ' . $delimiter . 'ribbonbar_tab.tab_order' . $delimiter . ',active as ' . $delimiter . 'ribbonbar_tab.active' . $delimiter . ',imagepath as ' . $delimiter . 'ribbonbar_tab.imagepath' . $delimiter . ',name as ' . $delimiter . 'ribbonbar_tab.name' . $delimiter . ',id_ribbonbar as ' . $delimiter . 'ribbonbar_tab.id_ribbonbar' . $delimiter . ',id as ' . $delimiter . 'ribbonbar_tab.id' . $delimiter . ' from ribbonbar_tab';
}
