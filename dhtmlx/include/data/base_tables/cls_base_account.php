...
{
	return array('id','id_account_chart_of_account','accountno','name');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'account.id' . $delimiter . ',id_account_chart_of_account as ' . $delimiter . 'account.id_account_chart_of_account' . $delimiter . ',accountno as ' . $delimiter . 'account.accountno' . $delimiter . ',name as ' . $delimiter . 'account.name' . $delimiter . ' from account';
}
