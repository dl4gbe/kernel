...
{
	return array('id','comment_count','last_comment_uid','last_comment_name','last_comment_timestamp','cid','nid');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'drupal_node_comment_statistics.id' . $delimiter . ',comment_count as ' . $delimiter . 'drupal_node_comment_statistics.comment_count' . $delimiter . ',last_comment_uid as ' . $delimiter . 'drupal_node_comment_statistics.last_comment_uid' . $delimiter . ',last_comment_name as ' . $delimiter . 'drupal_node_comment_statistics.last_comment_name' . $delimiter . ',last_comment_timestamp as ' . $delimiter . 'drupal_node_comment_statistics.last_comment_timestamp' . $delimiter . ',cid as ' . $delimiter . 'drupal_node_comment_statistics.cid' . $delimiter . ',nid as ' . $delimiter . 'drupal_node_comment_statistics.nid' . $delimiter . ' from drupal_node_comment_statistics';
}
