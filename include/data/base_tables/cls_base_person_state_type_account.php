...
{
	return array('id_account_payable','id_account_receivable','id_chart_of_account','id_person_state_type','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select id_account_payable as ' . $delimiter . 'person_state_type_account.id_account_payable' . $delimiter . ',id_account_receivable as ' . $delimiter . 'person_state_type_account.id_account_receivable' . $delimiter . ',id_chart_of_account as ' . $delimiter . 'person_state_type_account.id_chart_of_account' . $delimiter . ',id_person_state_type as ' . $delimiter . 'person_state_type_account.id_person_state_type' . $delimiter . ',id as ' . $delimiter . 'person_state_type_account.id' . $delimiter . ' from person_state_type_account';
}
