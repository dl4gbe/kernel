...
{
	return array('language','name','native','direction','enabled','plurals','formula','domain','prefix','weight','javascript','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select language as ' . $delimiter . 'drupal_languages.language' . $delimiter . ',name as ' . $delimiter . 'drupal_languages.name' . $delimiter . ',native as ' . $delimiter . 'drupal_languages.native' . $delimiter . ',direction as ' . $delimiter . 'drupal_languages.direction' . $delimiter . ',enabled as ' . $delimiter . 'drupal_languages.enabled' . $delimiter . ',plurals as ' . $delimiter . 'drupal_languages.plurals' . $delimiter . ',formula as ' . $delimiter . 'drupal_languages.formula' . $delimiter . ',domain as ' . $delimiter . 'drupal_languages.domain' . $delimiter . ',prefix as ' . $delimiter . 'drupal_languages.prefix' . $delimiter . ',weight as ' . $delimiter . 'drupal_languages.weight' . $delimiter . ',javascript as ' . $delimiter . 'drupal_languages.javascript' . $delimiter . ',id as ' . $delimiter . 'drupal_languages.id' . $delimiter . ' from drupal_languages';
}
