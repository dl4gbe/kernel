...
{
	return array('state','id_communication_event_previous','remark','donedate','id_person_employee_done','plandate','id_person_employee_planned','id_communication','id_person','id_event_type','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select state as ' . $delimiter . 'communication_event.state' . $delimiter . ',id_communication_event_previous as ' . $delimiter . 'communication_event.id_communication_event_previous' . $delimiter . ',remark as ' . $delimiter . 'communication_event.remark' . $delimiter . ',donedate as ' . $delimiter . 'communication_event.donedate' . $delimiter . ',id_person_employee_done as ' . $delimiter . 'communication_event.id_person_employee_done' . $delimiter . ',plandate as ' . $delimiter . 'communication_event.plandate' . $delimiter . ',id_person_employee_planned as ' . $delimiter . 'communication_event.id_person_employee_planned' . $delimiter . ',id_communication as ' . $delimiter . 'communication_event.id_communication' . $delimiter . ',id_person as ' . $delimiter . 'communication_event.id_person' . $delimiter . ',id_event_type as ' . $delimiter . 'communication_event.id_event_type' . $delimiter . ',id as ' . $delimiter . 'communication_event.id' . $delimiter . ' from communication_event';
}
