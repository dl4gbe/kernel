...
{
	return array('version','autor','beschreibung','datum','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select version as ' . $delimiter . 'geodb_changelog.version' . $delimiter . ',autor as ' . $delimiter . 'geodb_changelog.autor' . $delimiter . ',beschreibung as ' . $delimiter . 'geodb_changelog.beschreibung' . $delimiter . ',datum as ' . $delimiter . 'geodb_changelog.datum' . $delimiter . ',id as ' . $delimiter . 'geodb_changelog.id' . $delimiter . ' from geodb_changelog';
}
