...
{
	return array('id','firstname','lastname','middlename','id_salutation','birthdate','id_country_nationality','id_bank_account','paymenttype','cardno','id_article_price_group','personno','name');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'person.id' . $delimiter . ',firstname as ' . $delimiter . 'person.firstname' . $delimiter . ',lastname as ' . $delimiter . 'person.lastname' . $delimiter . ',middlename as ' . $delimiter . 'person.middlename' . $delimiter . ',id_salutation as ' . $delimiter . 'person.id_salutation' . $delimiter . ',birthdate as ' . $delimiter . 'person.birthdate' . $delimiter . ',id_country_nationality as ' . $delimiter . 'person.id_country_nationality' . $delimiter . ',id_bank_account as ' . $delimiter . 'person.id_bank_account' . $delimiter . ',paymenttype as ' . $delimiter . 'person.paymenttype' . $delimiter . ',cardno as ' . $delimiter . 'person.cardno' . $delimiter . ',id_article_price_group as ' . $delimiter . 'person.id_article_price_group' . $delimiter . ',personno as ' . $delimiter . 'person.personno' . $delimiter . ',name as ' . $delimiter . 'person.name' . $delimiter . ' from person';
}
