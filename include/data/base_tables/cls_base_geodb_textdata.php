...
{
	return array('date_type_until','valid_until','date_type_since','valid_since','is_default_name','is_native_lang','text_locale','text_val','text_type','loc_id');
}

public function get_table_select($delimiter = '"')
{
	return 'select date_type_until as ' . $delimiter . 'geodb_textdata.date_type_until' . $delimiter . ',valid_until as ' . $delimiter . 'geodb_textdata.valid_until' . $delimiter . ',date_type_since as ' . $delimiter . 'geodb_textdata.date_type_since' . $delimiter . ',valid_since as ' . $delimiter . 'geodb_textdata.valid_since' . $delimiter . ',is_default_name as ' . $delimiter . 'geodb_textdata.is_default_name' . $delimiter . ',is_native_lang as ' . $delimiter . 'geodb_textdata.is_native_lang' . $delimiter . ',text_locale as ' . $delimiter . 'geodb_textdata.text_locale' . $delimiter . ',text_val as ' . $delimiter . 'geodb_textdata.text_val' . $delimiter . ',text_type as ' . $delimiter . 'geodb_textdata.text_type' . $delimiter . ',loc_id as ' . $delimiter . 'geodb_textdata.loc_id' . $delimiter . ' from geodb_textdata';
}
