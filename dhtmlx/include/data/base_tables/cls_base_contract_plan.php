...
{
	return array('id','datefrom','datetil','amount','duedate','id_posting_header','type','id_contract_pos','paymenttype');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'contract_plan.id' . $delimiter . ',datefrom as ' . $delimiter . 'contract_plan.datefrom' . $delimiter . ',datetil as ' . $delimiter . 'contract_plan.datetil' . $delimiter . ',amount as ' . $delimiter . 'contract_plan.amount' . $delimiter . ',duedate as ' . $delimiter . 'contract_plan.duedate' . $delimiter . ',id_posting_header as ' . $delimiter . 'contract_plan.id_posting_header' . $delimiter . ',type as ' . $delimiter . 'contract_plan.type' . $delimiter . ',id_contract_pos as ' . $delimiter . 'contract_plan.id_contract_pos' . $delimiter . ',paymenttype as ' . $delimiter . 'contract_plan.paymenttype' . $delimiter . ' from contract_plan';
}
