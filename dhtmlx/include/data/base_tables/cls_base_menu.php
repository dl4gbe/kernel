...
{
	return array('id','id_application','name','id_menu_template','caption','id_data_view');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'menu.id' . $delimiter . ',id_application as ' . $delimiter . 'menu.id_application' . $delimiter . ',name as ' . $delimiter . 'menu.name' . $delimiter . ',id_menu_template as ' . $delimiter . 'menu.id_menu_template' . $delimiter . ',caption as ' . $delimiter . 'menu.caption' . $delimiter . ',id_data_view as ' . $delimiter . 'menu.id_data_view' . $delimiter . ' from menu';
}
