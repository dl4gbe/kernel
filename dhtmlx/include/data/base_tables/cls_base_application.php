...
{
	return array('id','name','caption','id_application_template','id_application_controller','id_main_page');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'application.id' . $delimiter . ',name as ' . $delimiter . 'application.name' . $delimiter . ',caption as ' . $delimiter . 'application.caption' . $delimiter . ',id_application_template as ' . $delimiter . 'application.id_application_template' . $delimiter . ',id_application_controller as ' . $delimiter . 'application.id_application_controller' . $delimiter . ',id_main_page as ' . $delimiter . 'application.id_main_page' . $delimiter . ' from application';
}
