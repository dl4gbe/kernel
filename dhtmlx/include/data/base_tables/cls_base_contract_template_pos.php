...
{
	return array('id','id_contract_template','name','id_article','maincontract','durationinmonths','amountperday','amountperweek','amountpermonth','amountperyear','increasepermonth','increaseperyear','freeunitsperday','freeunitsperweek','freeunitspermonth','freeunitsperyear','optional','paymentinterval','paymentcycle');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'contract_template_pos.id' . $delimiter . ',id_contract_template as ' . $delimiter . 'contract_template_pos.id_contract_template' . $delimiter . ',name as ' . $delimiter . 'contract_template_pos.name' . $delimiter . ',id_article as ' . $delimiter . 'contract_template_pos.id_article' . $delimiter . ',maincontract as ' . $delimiter . 'contract_template_pos.maincontract' . $delimiter . ',durationinmonths as ' . $delimiter . 'contract_template_pos.durationinmonths' . $delimiter . ',amountperday as ' . $delimiter . 'contract_template_pos.amountperday' . $delimiter . ',amountperweek as ' . $delimiter . 'contract_template_pos.amountperweek' . $delimiter . ',amountpermonth as ' . $delimiter . 'contract_template_pos.amountpermonth' . $delimiter . ',amountperyear as ' . $delimiter . 'contract_template_pos.amountperyear' . $delimiter . ',increasepermonth as ' . $delimiter . 'contract_template_pos.increasepermonth' . $delimiter . ',increaseperyear as ' . $delimiter . 'contract_template_pos.increaseperyear' . $delimiter . ',freeunitsperday as ' . $delimiter . 'contract_template_pos.freeunitsperday' . $delimiter . ',freeunitsperweek as ' . $delimiter . 'contract_template_pos.freeunitsperweek' . $delimiter . ',freeunitspermonth as ' . $delimiter . 'contract_template_pos.freeunitspermonth' . $delimiter . ',freeunitsperyear as ' . $delimiter . 'contract_template_pos.freeunitsperyear' . $delimiter . ',optional as ' . $delimiter . 'contract_template_pos.optional' . $delimiter . ',paymentinterval as ' . $delimiter . 'contract_template_pos.paymentinterval' . $delimiter . ',paymentcycle as ' . $delimiter . 'contract_template_pos.paymentcycle' . $delimiter . ' from contract_template_pos';
}
