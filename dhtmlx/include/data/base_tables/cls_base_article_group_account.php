...
{
	return array('id','id_article_group','id_chart_of_account','id_account_revenue_account','id_account_expense_account','id_account_rent_revenue_account');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'article_group_account.id' . $delimiter . ',id_article_group as ' . $delimiter . 'article_group_account.id_article_group' . $delimiter . ',id_chart_of_account as ' . $delimiter . 'article_group_account.id_chart_of_account' . $delimiter . ',id_account_revenue_account as ' . $delimiter . 'article_group_account.id_account_revenue_account' . $delimiter . ',id_account_expense_account as ' . $delimiter . 'article_group_account.id_account_expense_account' . $delimiter . ',id_account_rent_revenue_account as ' . $delimiter . 'article_group_account.id_account_rent_revenue_account' . $delimiter . ' from article_group_account';
}
