...
{
	return array('remark','min_order_days','min_order_qty','name','orderno','id_data','id_person_manufactorer','id_person_supplier','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select remark as ' . $delimiter . 'supplier_data.remark' . $delimiter . ',min_order_days as ' . $delimiter . 'supplier_data.min_order_days' . $delimiter . ',min_order_qty as ' . $delimiter . 'supplier_data.min_order_qty' . $delimiter . ',name as ' . $delimiter . 'supplier_data.name' . $delimiter . ',orderno as ' . $delimiter . 'supplier_data.orderno' . $delimiter . ',id_data as ' . $delimiter . 'supplier_data.id_data' . $delimiter . ',id_person_manufactorer as ' . $delimiter . 'supplier_data.id_person_manufactorer' . $delimiter . ',id_person_supplier as ' . $delimiter . 'supplier_data.id_person_supplier' . $delimiter . ',id as ' . $delimiter . 'supplier_data.id' . $delimiter . ' from supplier_data';
}
