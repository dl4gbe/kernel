...
{
	return array('id','timestamp','status','filesize','filemime','uri','filename','uid','fid');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'drupal_file_managed.id' . $delimiter . ',timestamp as ' . $delimiter . 'drupal_file_managed.timestamp' . $delimiter . ',status as ' . $delimiter . 'drupal_file_managed.status' . $delimiter . ',filesize as ' . $delimiter . 'drupal_file_managed.filesize' . $delimiter . ',filemime as ' . $delimiter . 'drupal_file_managed.filemime' . $delimiter . ',uri as ' . $delimiter . 'drupal_file_managed.uri' . $delimiter . ',filename as ' . $delimiter . 'drupal_file_managed.filename' . $delimiter . ',uid as ' . $delimiter . 'drupal_file_managed.uid' . $delimiter . ',fid as ' . $delimiter . 'drupal_file_managed.fid' . $delimiter . ' from drupal_file_managed';
}
