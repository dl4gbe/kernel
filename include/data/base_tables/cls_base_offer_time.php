...
{
	return array('remark','duration_in_minutes','timetil','timefrom','validtil','validfrom','dayofweek','id_offer','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select remark as ' . $delimiter . 'offer_time.remark' . $delimiter . ',duration_in_minutes as ' . $delimiter . 'offer_time.duration_in_minutes' . $delimiter . ',timetil as ' . $delimiter . 'offer_time.timetil' . $delimiter . ',timefrom as ' . $delimiter . 'offer_time.timefrom' . $delimiter . ',validtil as ' . $delimiter . 'offer_time.validtil' . $delimiter . ',validfrom as ' . $delimiter . 'offer_time.validfrom' . $delimiter . ',dayofweek as ' . $delimiter . 'offer_time.dayofweek' . $delimiter . ',id_offer as ' . $delimiter . 'offer_time.id_offer' . $delimiter . ',id as ' . $delimiter . 'offer_time.id' . $delimiter . ' from offer_time';
}
