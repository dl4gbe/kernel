...
{
	return array('id_person_employee','documentdate','no','transfertype','id_person','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select id_person_employee as ' . $delimiter . 'article_list.id_person_employee' . $delimiter . ',documentdate as ' . $delimiter . 'article_list.documentdate' . $delimiter . ',no as ' . $delimiter . 'article_list.no' . $delimiter . ',transfertype as ' . $delimiter . 'article_list.transfertype' . $delimiter . ',id_person as ' . $delimiter . 'article_list.id_person' . $delimiter . ',id as ' . $delimiter . 'article_list.id' . $delimiter . ' from article_list';
}
