...
{
	return array('id_contract_pos','id_contract','paymenttype','duedate','systemremark','period','id_offer_event','remark','id_posting_header_main_id','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select id_contract_pos as ' . $delimiter . 'posting_header.id_contract_pos' . $delimiter . ',id_contract as ' . $delimiter . 'posting_header.id_contract' . $delimiter . ',paymenttype as ' . $delimiter . 'posting_header.paymenttype' . $delimiter . ',duedate as ' . $delimiter . 'posting_header.duedate' . $delimiter . ',systemremark as ' . $delimiter . 'posting_header.systemremark' . $delimiter . ',period as ' . $delimiter . 'posting_header.period' . $delimiter . ',id_offer_event as ' . $delimiter . 'posting_header.id_offer_event' . $delimiter . ',remark as ' . $delimiter . 'posting_header.remark' . $delimiter . ',id_posting_header_main_id as ' . $delimiter . 'posting_header.id_posting_header_main_id' . $delimiter . ',id as ' . $delimiter . 'posting_header.id' . $delimiter . ' from posting_header';
}
