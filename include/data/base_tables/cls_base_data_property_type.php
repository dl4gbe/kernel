...
{
	return array('lookuptable_wherecondition','lookuptable_namefield5','lookuptable_namefield4','lookuptable_namefield3','lookuptable_namefield2','lookuptable_namefield1','lookuptable_idfield','lookuptablename','active','defaultvalue','id_person_states','datatype','name','tablename','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select lookuptable_wherecondition as ' . $delimiter . 'data_property_type.lookuptable_wherecondition' . $delimiter . ',lookuptable_namefield5 as ' . $delimiter . 'data_property_type.lookuptable_namefield5' . $delimiter . ',lookuptable_namefield4 as ' . $delimiter . 'data_property_type.lookuptable_namefield4' . $delimiter . ',lookuptable_namefield3 as ' . $delimiter . 'data_property_type.lookuptable_namefield3' . $delimiter . ',lookuptable_namefield2 as ' . $delimiter . 'data_property_type.lookuptable_namefield2' . $delimiter . ',lookuptable_namefield1 as ' . $delimiter . 'data_property_type.lookuptable_namefield1' . $delimiter . ',lookuptable_idfield as ' . $delimiter . 'data_property_type.lookuptable_idfield' . $delimiter . ',lookuptablename as ' . $delimiter . 'data_property_type.lookuptablename' . $delimiter . ',active as ' . $delimiter . 'data_property_type.active' . $delimiter . ',defaultvalue as ' . $delimiter . 'data_property_type.defaultvalue' . $delimiter . ',id_person_states as ' . $delimiter . 'data_property_type.id_person_states' . $delimiter . ',datatype as ' . $delimiter . 'data_property_type.datatype' . $delimiter . ',name as ' . $delimiter . 'data_property_type.name' . $delimiter . ',tablename as ' . $delimiter . 'data_property_type.tablename' . $delimiter . ',id as ' . $delimiter . 'data_property_type.id' . $delimiter . ' from data_property_type';
}
