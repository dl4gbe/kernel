...
{
	return array('id','id_article','deposit','id_article_price_group','validfrom','validtil','price_per_unit','id_time_unit');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'article_rent_price.id' . $delimiter . ',id_article as ' . $delimiter . 'article_rent_price.id_article' . $delimiter . ',deposit as ' . $delimiter . 'article_rent_price.deposit' . $delimiter . ',id_article_price_group as ' . $delimiter . 'article_rent_price.id_article_price_group' . $delimiter . ',validfrom as ' . $delimiter . 'article_rent_price.validfrom' . $delimiter . ',validtil as ' . $delimiter . 'article_rent_price.validtil' . $delimiter . ',price_per_unit as ' . $delimiter . 'article_rent_price.price_per_unit' . $delimiter . ',id_time_unit as ' . $delimiter . 'article_rent_price.id_time_unit' . $delimiter . ' from article_rent_price';
}
