...
{
	return 'select id as ' . $delimiter . 'article_fixed_asset.id' . $delimiter . ',id_article as ' . $delimiter . 'article_fixed_asset.id_article' . $delimiter . ',id_fixed_asset as ' . $delimiter . 'article_fixed_asset.id_fixed_asset' . $delimiter . ' from article_fixed_asset';
}
