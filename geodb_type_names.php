...
require_once('table_helpers/cls_geodb_type_names_helpers.php');
$app = new cls_application();
$get_parameter = new cls_get_parameter();
$helper = new cls_geodb_type_names_helpers($app->get_db_manager(),$app);
	...
	switch ($mode)
		{
			...
			case "sql_create":
				...
				return $orm->create_table_sql_statement("geodb_type_names",$get_parameter->database_type);
				break;
		}
	exit;
}
