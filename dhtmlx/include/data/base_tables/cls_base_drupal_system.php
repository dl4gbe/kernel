...
{
	return array('filename','name','type','owner','status','bootstrap','schema_version','weight','info','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select filename as ' . $delimiter . 'drupal_system.filename' . $delimiter . ',name as ' . $delimiter . 'drupal_system.name' . $delimiter . ',type as ' . $delimiter . 'drupal_system.type' . $delimiter . ',owner as ' . $delimiter . 'drupal_system.owner' . $delimiter . ',status as ' . $delimiter . 'drupal_system.status' . $delimiter . ',bootstrap as ' . $delimiter . 'drupal_system.bootstrap' . $delimiter . ',schema_version as ' . $delimiter . 'drupal_system.schema_version' . $delimiter . ',weight as ' . $delimiter . 'drupal_system.weight' . $delimiter . ',info as ' . $delimiter . 'drupal_system.info' . $delimiter . ',id as ' . $delimiter . 'drupal_system.id' . $delimiter . ' from drupal_system';
}
