...
{
	return array('id','id_swift_statement','retrieval_date','retrieval_no','account_number','amount','bankcode','business_transaction_code','business_transaction_text','charges_amount','charges_currency_code','customer_reference','entry_date','institution_reference','name','original_amount','original_currency_code','prima_note_number','purpose','reversal','supplementary_details','textkey_supplement','transaction_type','validity_date','equivalent_amount','equivalent_currency_code','currency_code','real_validity_date','statement_number','contains_sepa','creditor_id','different_originator','end_to_end_id','mandate_reference','originator_id','sepa_purpose','next_closing_balance_amount','next_closing_balance_currency_code','next_closing_balance_date','next_interim_closing_amount','next_interim_closing_balance_date','next_interim_closing_currency_code','prev_interim_balance_amount','prev_interim_balance_currency_code','prev_interim_balance_date','prev_opening_balance_amount','prev_opening_balance_currency_code','prev_opening_balance_date','bic','compensation_amount','different_recipient','iban','purpose_code');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'swift_statement_line.id' . $delimiter . ',id_swift_statement as ' . $delimiter . 'swift_statement_line.id_swift_statement' . $delimiter . ',retrieval_date as ' . $delimiter . 'swift_statement_line.retrieval_date' . $delimiter . ',retrieval_no as ' . $delimiter . 'swift_statement_line.retrieval_no' . $delimiter . ',account_number as ' . $delimiter . 'swift_statement_line.account_number' . $delimiter . ',amount as ' . $delimiter . 'swift_statement_line.amount' . $delimiter . ',bankcode as ' . $delimiter . 'swift_statement_line.bankcode' . $delimiter . ',business_transaction_code as ' . $delimiter . 'swift_statement_line.business_transaction_code' . $delimiter . ',business_transaction_text as ' . $delimiter . 'swift_statement_line.business_transaction_text' . $delimiter . ',charges_amount as ' . $delimiter . 'swift_statement_line.charges_amount' . $delimiter . ',charges_currency_code as ' . $delimiter . 'swift_statement_line.charges_currency_code' . $delimiter . ',customer_reference as ' . $delimiter . 'swift_statement_line.customer_reference' . $delimiter . ',entry_date as ' . $delimiter . 'swift_statement_line.entry_date' . $delimiter . ',institution_reference as ' . $delimiter . 'swift_statement_line.institution_reference' . $delimiter . ',name as ' . $delimiter . 'swift_statement_line.name' . $delimiter . ',original_amount as ' . $delimiter . 'swift_statement_line.original_amount' . $delimiter . ',original_currency_code as ' . $delimiter . 'swift_statement_line.original_currency_code' . $delimiter . ',prima_note_number as ' . $delimiter . 'swift_statement_line.prima_note_number' . $delimiter . ',purpose as ' . $delimiter . 'swift_statement_line.purpose' . $delimiter . ',reversal as ' . $delimiter . 'swift_statement_line.reversal' . $delimiter . ',supplementary_details as ' . $delimiter . 'swift_statement_line.supplementary_details' . $delimiter . ',textkey_supplement as ' . $delimiter . 'swift_statement_line.textkey_supplement' . $delimiter . ',transaction_type as ' . $delimiter . 'swift_statement_line.transaction_type' . $delimiter . ',validity_date as ' . $delimiter . 'swift_statement_line.validity_date' . $delimiter . ',equivalent_amount as ' . $delimiter . 'swift_statement_line.equivalent_amount' . $delimiter . ',equivalent_currency_code as ' . $delimiter . 'swift_statement_line.equivalent_currency_code' . $delimiter . ',currency_code as ' . $delimiter . 'swift_statement_line.currency_code' . $delimiter . ',real_validity_date as ' . $delimiter . 'swift_statement_line.real_validity_date' . $delimiter . ',statement_number as ' . $delimiter . 'swift_statement_line.statement_number' . $delimiter . ',contains_sepa as ' . $delimiter . 'swift_statement_line.contains_sepa' . $delimiter . ',creditor_id as ' . $delimiter . 'swift_statement_line.creditor_id' . $delimiter . ',different_originator as ' . $delimiter . 'swift_statement_line.different_originator' . $delimiter . ',end_to_end_id as ' . $delimiter . 'swift_statement_line.end_to_end_id' . $delimiter . ',mandate_reference as ' . $delimiter . 'swift_statement_line.mandate_reference' . $delimiter . ',originator_id as ' . $delimiter . 'swift_statement_line.originator_id' . $delimiter . ',sepa_purpose as ' . $delimiter . 'swift_statement_line.sepa_purpose' . $delimiter . ',next_closing_balance_amount as ' . $delimiter . 'swift_statement_line.next_closing_balance_amount' . $delimiter . ',next_closing_balance_currency_code as ' . $delimiter . 'swift_statement_line.next_closing_balance_currency_code' . $delimiter . ',next_closing_balance_date as ' . $delimiter . 'swift_statement_line.next_closing_balance_date' . $delimiter . ',next_interim_closing_amount as ' . $delimiter . 'swift_statement_line.next_interim_closing_amount' . $delimiter . ',next_interim_closing_balance_date as ' . $delimiter . 'swift_statement_line.next_interim_closing_balance_date' . $delimiter . ',next_interim_closing_currency_code as ' . $delimiter . 'swift_statement_line.next_interim_closing_currency_code' . $delimiter . ',prev_interim_balance_amount as ' . $delimiter . 'swift_statement_line.prev_interim_balance_amount' . $delimiter . ',prev_interim_balance_currency_code as ' . $delimiter . 'swift_statement_line.prev_interim_balance_currency_code' . $delimiter . ',prev_interim_balance_date as ' . $delimiter . 'swift_statement_line.prev_interim_balance_date' . $delimiter . ',prev_opening_balance_amount as ' . $delimiter . 'swift_statement_line.prev_opening_balance_amount' . $delimiter . ',prev_opening_balance_currency_code as ' . $delimiter . 'swift_statement_line.prev_opening_balance_currency_code' . $delimiter . ',prev_opening_balance_date as ' . $delimiter . 'swift_statement_line.prev_opening_balance_date' . $delimiter . ',bic as ' . $delimiter . 'swift_statement_line.bic' . $delimiter . ',compensation_amount as ' . $delimiter . 'swift_statement_line.compensation_amount' . $delimiter . ',different_recipient as ' . $delimiter . 'swift_statement_line.different_recipient' . $delimiter . ',iban as ' . $delimiter . 'swift_statement_line.iban' . $delimiter . ',purpose_code as ' . $delimiter . 'swift_statement_line.purpose_code' . $delimiter . ' from swift_statement_line';
}
