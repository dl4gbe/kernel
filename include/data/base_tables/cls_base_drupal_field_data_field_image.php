...
abstract class cls_base_drupal_field_data_field_image extends cls_datatable_base
{
...
{
	return 'drupal_field_data_field_image';
}

public function get_table_fields()
{
	return array('id','field_image_height','field_image_width','field_image_title','field_image_alt','field_image_fid','delta','language','revision_id','entity_id','deleted','bundle','entity_type');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'drupal_field_data_field_image.id' . $delimiter . ',field_image_height as ' . $delimiter . 'drupal_field_data_field_image.field_image_height' . $delimiter . ',field_image_width as ' . $delimiter . 'drupal_field_data_field_image.field_image_width' . $delimiter . ',field_image_title as ' . $delimiter . 'drupal_field_data_field_image.field_image_title' . $delimiter . ',field_image_alt as ' . $delimiter . 'drupal_field_data_field_image.field_image_alt' . $delimiter . ',field_image_fid as ' . $delimiter . 'drupal_field_data_field_image.field_image_fid' . $delimiter . ',delta as ' . $delimiter . 'drupal_field_data_field_image.delta' . $delimiter . ',language as ' . $delimiter . 'drupal_field_data_field_image.language' . $delimiter . ',revision_id as ' . $delimiter . 'drupal_field_data_field_image.revision_id' . $delimiter . ',entity_id as ' . $delimiter . 'drupal_field_data_field_image.entity_id' . $delimiter . ',deleted as ' . $delimiter . 'drupal_field_data_field_image.deleted' . $delimiter . ',bundle as ' . $delimiter . 'drupal_field_data_field_image.bundle' . $delimiter . ',entity_type as ' . $delimiter . 'drupal_field_data_field_image.entity_type' . $delimiter . ' from drupal_field_data_field_image';
}
...
public function get_by_id($id,$db_manager,$application = null)
{
	...
	if (!is_null($result))
	{
		...
		$drupal_field_data_field_image = cls_table_factory::create_instance('drupal_field_data_field_image');
		$row = $db_manager->fetch_row($result);
		$drupal_field_data_field_image->fill($row);
		return $drupal_field_data_field_image;
	}
}
...
public function save($db_manager,$application)
	{
		require_once('include/data/base_table_savers/cls_save_drupal_field_data_field_image.php');
		return cls_save_drupal_field_data_field_image::save_object($this,$db_manager,$application);
	}

public function save_array($data,$db_manager,$application)
	{
		require_once('include/data/base_table_savers/cls_save_drupal_field_data_field_image.php');
		return cls_save_drupal_field_data_field_image::save_array($data,$db_manager,$application);
	}
...
public function get_drupal_field_data_field_images($db_manager,$application,$search_values,$limit = 0,$offset = 0,$use_key_value = false)
	{
		$result = null;
		if (empty($seach_values))
		{
			$result = $db_manager->search_for_records('drupal_field_data_field_image',null,null,$limit,$offset);
		}
		else
		{
			$result = $db_manager->search_for_records('drupal_field_data_field_image',$this->get_search_fields(),$seach_values,$limit,$offset);
		}
		...
		while (($row=$db_manager->fetch_by_assoc($result)) !=null)
			{
				$drupal_field_data_field_image = cls_table_factory::create_instance('drupal_field_data_field_image');
				$drupal_field_data_field_image->fill($row);
				$data[] = $drupal_field_data_field_image;
			}
		return $data;
	}

public function get_table_test_data($drupal_field_data_field_images,$db_manager,$application,$use_key_value = false)
	{
...
public function get_multi_table_test_data($drupal_field_data_field_images,$db_manager,$application)
	{
		$result = $db_manager->get_records_by_ids('table_test_data',$drupal_field_data_field_images,'id_data');
		if (is_null($result)) return null;
		if (count($result) == 0) return null;
		require_once('include/data/table_factory/cls_table_factory.php');
		$data = array();
...
public function get_communication_reason($drupal_field_data_field_images,$db_manager,$application,$use_key_value = false)
	{
...
public function get_multi_communication_reason($drupal_field_data_field_images,$db_manager,$application)
	{
		$result = $db_manager->get_records_by_ids('communication_reason',$drupal_field_data_field_images,'id_data');
		if (is_null($result)) return null;
		if (count($result) == 0) return null;
		require_once('include/data/table_factory/cls_table_factory.php');
		$data = array();
...
public function get_data_change($drupal_field_data_field_images,$db_manager,$application,$use_key_value = false)
	{
...
public function get_multi_data_change($drupal_field_data_field_images,$db_manager,$application)
	{
		$result = $db_manager->get_records_by_ids('data_change',$drupal_field_data_field_images,'id_data');
		if (is_null($result)) return null;
		if (count($result) == 0) return null;
		require_once('include/data/table_factory/cls_table_factory.php');
		$data = array();
...
public function get_data_help($drupal_field_data_field_images,$db_manager,$application,$use_key_value = false)
	{
...
public function get_multi_data_help($drupal_field_data_field_images,$db_manager,$application)
	{
		$result = $db_manager->get_records_by_ids('data_help',$drupal_field_data_field_images,'id_data');
		if (is_null($result)) return null;
		if (count($result) == 0) return null;
		require_once('include/data/table_factory/cls_table_factory.php');
		$data = array();
...
public function get_data_location($drupal_field_data_field_images,$db_manager,$application,$use_key_value = false)
	{
...
public function get_multi_data_location($drupal_field_data_field_images,$db_manager,$application)
	{
		$result = $db_manager->get_records_by_ids('data_location',$drupal_field_data_field_images,'id_data');
		if (is_null($result)) return null;
		if (count($result) == 0) return null;
		require_once('include/data/table_factory/cls_table_factory.php');
		$data = array();
...
public function get_data_posting($drupal_field_data_field_images,$db_manager,$application,$use_key_value = false)
	{
...
public function get_multi_data_posting($drupal_field_data_field_images,$db_manager,$application)
	{
		$result = $db_manager->get_records_by_ids('data_posting',$drupal_field_data_field_images,'id_data');
		if (is_null($result)) return null;
		if (count($result) == 0) return null;
		require_once('include/data/table_factory/cls_table_factory.php');
		$data = array();
...
public function get_offer_event($drupal_field_data_field_images,$db_manager,$application,$use_key_value = false)
	{
...
public function get_multi_offer_event($drupal_field_data_field_images,$db_manager,$application)
	{
		$result = $db_manager->get_records_by_ids('offer_event',$drupal_field_data_field_images,'id_data');
		if (is_null($result)) return null;
		if (count($result) == 0) return null;
		require_once('include/data/table_factory/cls_table_factory.php');
		$data = array();
...
public function get_supplier_data($drupal_field_data_field_images,$db_manager,$application,$use_key_value = false)
	{
...
public function get_multi_supplier_data($drupal_field_data_field_images,$db_manager,$application)
	{
		$result = $db_manager->get_records_by_ids('supplier_data',$drupal_field_data_field_images,'id_data');
		if (is_null($result)) return null;
		if (count($result) == 0) return null;
		require_once('include/data/table_factory/cls_table_factory.php');
		$data = array();
...
public function get_address($drupal_field_data_field_images,$db_manager,$application,$use_key_value = false)
	{
...
public function get_multi_address($drupal_field_data_field_images,$db_manager,$application)
	{
		$result = $db_manager->get_records_by_ids('address',$drupal_field_data_field_images,'id_data');
		if (is_null($result)) return null;
		if (count($result) == 0) return null;
		require_once('include/data/table_factory/cls_table_factory.php');
		$data = array();
...
public function get_data_property($drupal_field_data_field_images,$db_manager,$application,$use_key_value = false)
	{
...
public function get_multi_data_property($drupal_field_data_field_images,$db_manager,$application)
	{
		$result = $db_manager->get_records_by_ids('data_property',$drupal_field_data_field_images,'id_data');
		if (is_null($result)) return null;
		if (count($result) == 0) return null;
		require_once('include/data/table_factory/cls_table_factory.php');
		$data = array();
...
public function get_data_translation($drupal_field_data_field_images,$db_manager,$application,$use_key_value = false)
	{
...
public function get_multi_data_translation($drupal_field_data_field_images,$db_manager,$application)
	{
		$result = $db_manager->get_records_by_ids('data_translation',$drupal_field_data_field_images,'id_data');
		if (is_null($result)) return null;
		if (count($result) == 0) return null;
		require_once('include/data/table_factory/cls_table_factory.php');
		$data = array();
...
public function get_dms($drupal_field_data_field_images,$db_manager,$application,$use_key_value = false)
	{
...
public function get_multi_dms($drupal_field_data_field_images,$db_manager,$application)
	{
		$result = $db_manager->get_records_by_ids('dms',$drupal_field_data_field_images,'id_data');
		if (is_null($result)) return null;
		if (count($result) == 0) return null;
		require_once('include/data/table_factory/cls_table_factory.php');
		$data = array();
...
public function get_data_relation_id_data1($drupal_field_data_field_images,$db_manager,$application,$use_key_value = false)
	{
...
public function get_multi_data_relation_id_data1($drupal_field_data_field_images,$db_manager,$application)
	{
		$result = $db_manager->get_records_by_ids('data_relation',$drupal_field_data_field_images,'id_data1');
		if (is_null($result)) return null;
		if (count($result) == 0) return null;
		require_once('include/data/table_factory/cls_table_factory.php');
		$data = array();
...
public function get_data_relation_id_data2($drupal_field_data_field_images,$db_manager,$application,$use_key_value = false)
	{
...
public function get_multi_data_relation_id_data2($drupal_field_data_field_images,$db_manager,$application)
	{
		$result = $db_manager->get_records_by_ids('data_relation',$drupal_field_data_field_images,'id_data2');
		if (is_null($result)) return null;
		if (count($result) == 0) return null;
		require_once('include/data/table_factory/cls_table_factory.php');
		$data = array();
...
public function get_data_property_id_link_data($drupal_field_data_field_images,$db_manager,$application,$use_key_value = false)
	{
...
public function get_multi_data_property_id_link_data($drupal_field_data_field_images,$db_manager,$application)
	{
		$result = $db_manager->get_records_by_ids('data_property',$drupal_field_data_field_images,'id_link_data');
		if (is_null($result)) return null;
		if (count($result) == 0) return null;
		require_once('include/data/table_factory/cls_table_factory.php');
		$data = array();
