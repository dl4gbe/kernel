...
{
	return array('id','id_config_group','name','table_name','path','source');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'config_group_item.id' . $delimiter . ',id_config_group as ' . $delimiter . 'config_group_item.id_config_group' . $delimiter . ',name as ' . $delimiter . 'config_group_item.name' . $delimiter . ',table_name as ' . $delimiter . 'config_group_item.table_name' . $delimiter . ',path as ' . $delimiter . 'config_group_item.path' . $delimiter . ',source as ' . $delimiter . 'config_group_item.source' . $delimiter . ' from config_group_item';
}
