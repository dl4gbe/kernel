...
{
	return array('id','id_article','id_person','datefrom','datetil','id_posting_header','id_person_employee_issued','id_person_employee_returned','id_fixed_asset');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'article_person_rent.id' . $delimiter . ',id_article as ' . $delimiter . 'article_person_rent.id_article' . $delimiter . ',id_person as ' . $delimiter . 'article_person_rent.id_person' . $delimiter . ',datefrom as ' . $delimiter . 'article_person_rent.datefrom' . $delimiter . ',datetil as ' . $delimiter . 'article_person_rent.datetil' . $delimiter . ',id_posting_header as ' . $delimiter . 'article_person_rent.id_posting_header' . $delimiter . ',id_person_employee_issued as ' . $delimiter . 'article_person_rent.id_person_employee_issued' . $delimiter . ',id_person_employee_returned as ' . $delimiter . 'article_person_rent.id_person_employee_returned' . $delimiter . ',id_fixed_asset as ' . $delimiter . 'article_person_rent.id_fixed_asset' . $delimiter . ' from article_person_rent';
}
