...
{
	return array('id','name','id_uom','insurance_no','articleno','barcode','rentable');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'article.id' . $delimiter . ',name as ' . $delimiter . 'article.name' . $delimiter . ',id_uom as ' . $delimiter . 'article.id_uom' . $delimiter . ',insurance_no as ' . $delimiter . 'article.insurance_no' . $delimiter . ',articleno as ' . $delimiter . 'article.articleno' . $delimiter . ',barcode as ' . $delimiter . 'article.barcode' . $delimiter . ',rentable as ' . $delimiter . 'article.rentable' . $delimiter . ' from article';
}
