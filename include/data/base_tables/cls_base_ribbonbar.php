...
{
	return array('has_edit_form','id_ribbonbar_template','name','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select has_edit_form as ' . $delimiter . 'ribbonbar.has_edit_form' . $delimiter . ',id_ribbonbar_template as ' . $delimiter . 'ribbonbar.id_ribbonbar_template' . $delimiter . ',name as ' . $delimiter . 'ribbonbar.name' . $delimiter . ',id as ' . $delimiter . 'ribbonbar.id' . $delimiter . ' from ribbonbar';
}
