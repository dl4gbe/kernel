...
{
	return array('sollversteuerung','id_person_laywer','id_person_taxadvisor','id_person_revenue_department','taxid','id_insurance_district','id_chart_of_account','iscenter','ik','unique_credit_identifier','no','id_person','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select sollversteuerung as ' . $delimiter . 'location.sollversteuerung' . $delimiter . ',id_person_laywer as ' . $delimiter . 'location.id_person_laywer' . $delimiter . ',id_person_taxadvisor as ' . $delimiter . 'location.id_person_taxadvisor' . $delimiter . ',id_person_revenue_department as ' . $delimiter . 'location.id_person_revenue_department' . $delimiter . ',taxid as ' . $delimiter . 'location.taxid' . $delimiter . ',id_insurance_district as ' . $delimiter . 'location.id_insurance_district' . $delimiter . ',id_chart_of_account as ' . $delimiter . 'location.id_chart_of_account' . $delimiter . ',iscenter as ' . $delimiter . 'location.iscenter' . $delimiter . ',ik as ' . $delimiter . 'location.ik' . $delimiter . ',unique_credit_identifier as ' . $delimiter . 'location.unique_credit_identifier' . $delimiter . ',no as ' . $delimiter . 'location.no' . $delimiter . ',id_person as ' . $delimiter . 'location.id_person' . $delimiter . ',id as ' . $delimiter . 'location.id' . $delimiter . ' from location';
}
