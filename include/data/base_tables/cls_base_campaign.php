...
{
	return array('name','id_campaign_group','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select name as ' . $delimiter . 'campaign.name' . $delimiter . ',id_campaign_group as ' . $delimiter . 'campaign.id_campaign_group' . $delimiter . ',id as ' . $delimiter . 'campaign.id' . $delimiter . ' from campaign';
}
