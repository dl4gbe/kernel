...
{
	return array('id','name','id_article','maincontract','durationinmonths','amountperday','amountperweek','amountpermonth','amountperyear','increasepermonth','increaseperyear','freeunitsperday','freeunitsperweek','freeunitspermonth','freeunitsperyear');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'contract_template_item.id' . $delimiter . ',name as ' . $delimiter . 'contract_template_item.name' . $delimiter . ',id_article as ' . $delimiter . 'contract_template_item.id_article' . $delimiter . ',maincontract as ' . $delimiter . 'contract_template_item.maincontract' . $delimiter . ',durationinmonths as ' . $delimiter . 'contract_template_item.durationinmonths' . $delimiter . ',amountperday as ' . $delimiter . 'contract_template_item.amountperday' . $delimiter . ',amountperweek as ' . $delimiter . 'contract_template_item.amountperweek' . $delimiter . ',amountpermonth as ' . $delimiter . 'contract_template_item.amountpermonth' . $delimiter . ',amountperyear as ' . $delimiter . 'contract_template_item.amountperyear' . $delimiter . ',increasepermonth as ' . $delimiter . 'contract_template_item.increasepermonth' . $delimiter . ',increaseperyear as ' . $delimiter . 'contract_template_item.increaseperyear' . $delimiter . ',freeunitsperday as ' . $delimiter . 'contract_template_item.freeunitsperday' . $delimiter . ',freeunitsperweek as ' . $delimiter . 'contract_template_item.freeunitsperweek' . $delimiter . ',freeunitspermonth as ' . $delimiter . 'contract_template_item.freeunitspermonth' . $delimiter . ',freeunitsperyear as ' . $delimiter . 'contract_template_item.freeunitsperyear' . $delimiter . ' from contract_template_item';
}
