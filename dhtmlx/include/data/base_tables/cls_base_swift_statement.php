...
{
	return array('id','retrieval_date','account_identification_code','closing_available_balance_amount','closing_available_balance_currency_code','closing_available_balance_date','closing_balance_amount','closing_balance_currency_code','closing_balance_date','opening_balance_amount','opening_balance_currency_code','opening_balance_date','related_reference','statement_number','transaction_reference_number');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'swift_statement.id' . $delimiter . ',retrieval_date as ' . $delimiter . 'swift_statement.retrieval_date' . $delimiter . ',account_identification_code as ' . $delimiter . 'swift_statement.account_identification_code' . $delimiter . ',closing_available_balance_amount as ' . $delimiter . 'swift_statement.closing_available_balance_amount' . $delimiter . ',closing_available_balance_currency_code as ' . $delimiter . 'swift_statement.closing_available_balance_currency_code' . $delimiter . ',closing_available_balance_date as ' . $delimiter . 'swift_statement.closing_available_balance_date' . $delimiter . ',closing_balance_amount as ' . $delimiter . 'swift_statement.closing_balance_amount' . $delimiter . ',closing_balance_currency_code as ' . $delimiter . 'swift_statement.closing_balance_currency_code' . $delimiter . ',closing_balance_date as ' . $delimiter . 'swift_statement.closing_balance_date' . $delimiter . ',opening_balance_amount as ' . $delimiter . 'swift_statement.opening_balance_amount' . $delimiter . ',opening_balance_currency_code as ' . $delimiter . 'swift_statement.opening_balance_currency_code' . $delimiter . ',opening_balance_date as ' . $delimiter . 'swift_statement.opening_balance_date' . $delimiter . ',related_reference as ' . $delimiter . 'swift_statement.related_reference' . $delimiter . ',statement_number as ' . $delimiter . 'swift_statement.statement_number' . $delimiter . ',transaction_reference_number as ' . $delimiter . 'swift_statement.transaction_reference_number' . $delimiter . ' from swift_statement';
}
