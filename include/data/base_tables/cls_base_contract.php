...
{
	return array('contractno','accessdate','signeddate','contractstart','id_contract_template','id_bank_account','id_person_promoter','id_campaign','id_person_signer','id_person','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select contractno as ' . $delimiter . 'contract.contractno' . $delimiter . ',accessdate as ' . $delimiter . 'contract.accessdate' . $delimiter . ',signeddate as ' . $delimiter . 'contract.signeddate' . $delimiter . ',contractstart as ' . $delimiter . 'contract.contractstart' . $delimiter . ',id_contract_template as ' . $delimiter . 'contract.id_contract_template' . $delimiter . ',id_bank_account as ' . $delimiter . 'contract.id_bank_account' . $delimiter . ',id_person_promoter as ' . $delimiter . 'contract.id_person_promoter' . $delimiter . ',id_campaign as ' . $delimiter . 'contract.id_campaign' . $delimiter . ',id_person_signer as ' . $delimiter . 'contract.id_person_signer' . $delimiter . ',id_person as ' . $delimiter . 'contract.id_person' . $delimiter . ',id as ' . $delimiter . 'contract.id' . $delimiter . ' from contract';
}
