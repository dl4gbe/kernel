...
{
	return array('id','id_data_view','table_name','link_field');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'data_view_table.id' . $delimiter . ',id_data_view as ' . $delimiter . 'data_view_table.id_data_view' . $delimiter . ',table_name as ' . $delimiter . 'data_view_table.table_name' . $delimiter . ',link_field as ' . $delimiter . 'data_view_table.link_field' . $delimiter . ' from data_view_table';
}
