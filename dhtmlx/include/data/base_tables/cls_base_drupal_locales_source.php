...
{
	return array('lid','location','textgroup','source','context','version','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select lid as ' . $delimiter . 'drupal_locales_source.lid' . $delimiter . ',location as ' . $delimiter . 'drupal_locales_source.location' . $delimiter . ',textgroup as ' . $delimiter . 'drupal_locales_source.textgroup' . $delimiter . ',source as ' . $delimiter . 'drupal_locales_source.source' . $delimiter . ',context as ' . $delimiter . 'drupal_locales_source.context' . $delimiter . ',version as ' . $delimiter . 'drupal_locales_source.version' . $delimiter . ',id as ' . $delimiter . 'drupal_locales_source.id' . $delimiter . ' from drupal_locales_source';
}
