...
{
	return array('minqty','validtil','validfrom','id_article_price_group','price','id_article','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select minqty as ' . $delimiter . 'article_price.minqty' . $delimiter . ',validtil as ' . $delimiter . 'article_price.validtil' . $delimiter . ',validfrom as ' . $delimiter . 'article_price.validfrom' . $delimiter . ',id_article_price_group as ' . $delimiter . 'article_price.id_article_price_group' . $delimiter . ',price as ' . $delimiter . 'article_price.price' . $delimiter . ',id_article as ' . $delimiter . 'article_price.id_article' . $delimiter . ',id as ' . $delimiter . 'article_price.id' . $delimiter . ' from article_price';
}
