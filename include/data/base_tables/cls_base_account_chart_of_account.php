...
{
	return array('type','active','freedigits','name','accountno','id_account_group','id_chart_of_account','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select type as ' . $delimiter . 'account_chart_of_account.type' . $delimiter . ',active as ' . $delimiter . 'account_chart_of_account.active' . $delimiter . ',freedigits as ' . $delimiter . 'account_chart_of_account.freedigits' . $delimiter . ',name as ' . $delimiter . 'account_chart_of_account.name' . $delimiter . ',accountno as ' . $delimiter . 'account_chart_of_account.accountno' . $delimiter . ',id_account_group as ' . $delimiter . 'account_chart_of_account.id_account_group' . $delimiter . ',id_chart_of_account as ' . $delimiter . 'account_chart_of_account.id_chart_of_account' . $delimiter . ',id as ' . $delimiter . 'account_chart_of_account.id' . $delimiter . ' from account_chart_of_account';
}
