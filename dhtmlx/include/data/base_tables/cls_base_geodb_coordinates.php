...
{
	return 'select loc_id as ' . $delimiter . 'geodb_coordinates.loc_id' . $delimiter . ',coord_type as ' . $delimiter . 'geodb_coordinates.coord_type' . $delimiter . ',lat as ' . $delimiter . 'geodb_coordinates.lat' . $delimiter . ',lon as ' . $delimiter . 'geodb_coordinates.lon' . $delimiter . ',coord_subtype as ' . $delimiter . 'geodb_coordinates.coord_subtype' . $delimiter . ',valid_since as ' . $delimiter . 'geodb_coordinates.valid_since' . $delimiter . ',date_type_since as ' . $delimiter . 'geodb_coordinates.date_type_since' . $delimiter . ',valid_until as ' . $delimiter . 'geodb_coordinates.valid_until' . $delimiter . ',date_type_until as ' . $delimiter . 'geodb_coordinates.date_type_until' . $delimiter . ' from geodb_coordinates';
}
