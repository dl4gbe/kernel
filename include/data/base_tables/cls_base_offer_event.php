...
{
	return array('id_posting_header','id_device','data2','data1','datetil','datefrom','id_data','id_person','id_offer','id_event_type','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select id_posting_header as ' . $delimiter . 'offer_event.id_posting_header' . $delimiter . ',id_device as ' . $delimiter . 'offer_event.id_device' . $delimiter . ',data2 as ' . $delimiter . 'offer_event.data2' . $delimiter . ',data1 as ' . $delimiter . 'offer_event.data1' . $delimiter . ',datetil as ' . $delimiter . 'offer_event.datetil' . $delimiter . ',datefrom as ' . $delimiter . 'offer_event.datefrom' . $delimiter . ',id_data as ' . $delimiter . 'offer_event.id_data' . $delimiter . ',id_person as ' . $delimiter . 'offer_event.id_person' . $delimiter . ',id_offer as ' . $delimiter . 'offer_event.id_offer' . $delimiter . ',id_event_type as ' . $delimiter . 'offer_event.id_event_type' . $delimiter . ',id as ' . $delimiter . 'offer_event.id' . $delimiter . ' from offer_event';
}
