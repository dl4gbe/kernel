...
require_once('table_helpers/cls_drupal_block_custom_helpers.php');
$app = new cls_application();
$get_parameter = new cls_get_parameter();
$helper = new cls_drupal_block_custom_helpers($app->get_db_manager(),$app);
	...
	switch ($mode)
		{
			...
			case "sql_create":
				...
				return $orm->create_table_sql_statement("drupal_block_custom",$get_parameter->database_type);
				break;
		}
	exit;
}
