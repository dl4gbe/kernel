...
{
	return array('id','id_menu_group','name','id_control','order','imagepath','active','parameters','table_name','id_data_view');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'menu_item.id' . $delimiter . ',id_menu_group as ' . $delimiter . 'menu_item.id_menu_group' . $delimiter . ',name as ' . $delimiter . 'menu_item.name' . $delimiter . ',id_control as ' . $delimiter . 'menu_item.id_control' . $delimiter . ',order as ' . $delimiter . 'menu_item.order' . $delimiter . ',imagepath as ' . $delimiter . 'menu_item.imagepath' . $delimiter . ',active as ' . $delimiter . 'menu_item.active' . $delimiter . ',parameters as ' . $delimiter . 'menu_item.parameters' . $delimiter . ',table_name as ' . $delimiter . 'menu_item.table_name' . $delimiter . ',id_data_view as ' . $delimiter . 'menu_item.id_data_view' . $delimiter . ' from menu_item';
}
