...
{
	return array('tablename','name','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select tablename as ' . $delimiter . 'communication_reason_type.tablename' . $delimiter . ',name as ' . $delimiter . 'communication_reason_type.name' . $delimiter . ',id as ' . $delimiter . 'communication_reason_type.id' . $delimiter . ' from communication_reason_type';
}
