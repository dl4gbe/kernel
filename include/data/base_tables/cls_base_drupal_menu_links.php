...
{
	return array('id','updated','p9','p8','p7','p6','p5','p4','p3','p2','p1','customized','depth','weight','expanded','has_children','external','hidden','module','options','link_title','router_path','link_path','plid','mlid','menu_name');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'drupal_menu_links.id' . $delimiter . ',updated as ' . $delimiter . 'drupal_menu_links.updated' . $delimiter . ',p9 as ' . $delimiter . 'drupal_menu_links.p9' . $delimiter . ',p8 as ' . $delimiter . 'drupal_menu_links.p8' . $delimiter . ',p7 as ' . $delimiter . 'drupal_menu_links.p7' . $delimiter . ',p6 as ' . $delimiter . 'drupal_menu_links.p6' . $delimiter . ',p5 as ' . $delimiter . 'drupal_menu_links.p5' . $delimiter . ',p4 as ' . $delimiter . 'drupal_menu_links.p4' . $delimiter . ',p3 as ' . $delimiter . 'drupal_menu_links.p3' . $delimiter . ',p2 as ' . $delimiter . 'drupal_menu_links.p2' . $delimiter . ',p1 as ' . $delimiter . 'drupal_menu_links.p1' . $delimiter . ',customized as ' . $delimiter . 'drupal_menu_links.customized' . $delimiter . ',depth as ' . $delimiter . 'drupal_menu_links.depth' . $delimiter . ',weight as ' . $delimiter . 'drupal_menu_links.weight' . $delimiter . ',expanded as ' . $delimiter . 'drupal_menu_links.expanded' . $delimiter . ',has_children as ' . $delimiter . 'drupal_menu_links.has_children' . $delimiter . ',external as ' . $delimiter . 'drupal_menu_links.external' . $delimiter . ',hidden as ' . $delimiter . 'drupal_menu_links.hidden' . $delimiter . ',module as ' . $delimiter . 'drupal_menu_links.module' . $delimiter . ',options as ' . $delimiter . 'drupal_menu_links.options' . $delimiter . ',link_title as ' . $delimiter . 'drupal_menu_links.link_title' . $delimiter . ',router_path as ' . $delimiter . 'drupal_menu_links.router_path' . $delimiter . ',link_path as ' . $delimiter . 'drupal_menu_links.link_path' . $delimiter . ',plid as ' . $delimiter . 'drupal_menu_links.plid' . $delimiter . ',mlid as ' . $delimiter . 'drupal_menu_links.mlid' . $delimiter . ',menu_name as ' . $delimiter . 'drupal_menu_links.menu_name' . $delimiter . ' from drupal_menu_links';
}
