...
{
	return array('nid','vid','type','language','title','uid','status','created','changed','comment','promote','sticky','tnid','translate','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select nid as ' . $delimiter . 'drupal_node.nid' . $delimiter . ',vid as ' . $delimiter . 'drupal_node.vid' . $delimiter . ',type as ' . $delimiter . 'drupal_node.type' . $delimiter . ',language as ' . $delimiter . 'drupal_node.language' . $delimiter . ',title as ' . $delimiter . 'drupal_node.title' . $delimiter . ',uid as ' . $delimiter . 'drupal_node.uid' . $delimiter . ',status as ' . $delimiter . 'drupal_node.status' . $delimiter . ',created as ' . $delimiter . 'drupal_node.created' . $delimiter . ',changed as ' . $delimiter . 'drupal_node.changed' . $delimiter . ',comment as ' . $delimiter . 'drupal_node.comment' . $delimiter . ',promote as ' . $delimiter . 'drupal_node.promote' . $delimiter . ',sticky as ' . $delimiter . 'drupal_node.sticky' . $delimiter . ',tnid as ' . $delimiter . 'drupal_node.tnid' . $delimiter . ',translate as ' . $delimiter . 'drupal_node.translate' . $delimiter . ',id as ' . $delimiter . 'drupal_node.id' . $delimiter . ' from drupal_node';
}
