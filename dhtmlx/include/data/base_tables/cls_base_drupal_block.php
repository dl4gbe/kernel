...
{
	return array('bid','module','delta','theme','status','weight','region','custom','visibility','pages','title','cache','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select bid as ' . $delimiter . 'drupal_block.bid' . $delimiter . ',module as ' . $delimiter . 'drupal_block.module' . $delimiter . ',delta as ' . $delimiter . 'drupal_block.delta' . $delimiter . ',theme as ' . $delimiter . 'drupal_block.theme' . $delimiter . ',status as ' . $delimiter . 'drupal_block.status' . $delimiter . ',weight as ' . $delimiter . 'drupal_block.weight' . $delimiter . ',region as ' . $delimiter . 'drupal_block.region' . $delimiter . ',custom as ' . $delimiter . 'drupal_block.custom' . $delimiter . ',visibility as ' . $delimiter . 'drupal_block.visibility' . $delimiter . ',pages as ' . $delimiter . 'drupal_block.pages' . $delimiter . ',title as ' . $delimiter . 'drupal_block.title' . $delimiter . ',cache as ' . $delimiter . 'drupal_block.cache' . $delimiter . ',id as ' . $delimiter . 'drupal_block.id' . $delimiter . ' from drupal_block';
}
