...
{
	return array('bic','iban','city','zip','address','lastname','firstname','issuedate','signaturedate','mandatsreferenzno','id_bank_account','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select bic as ' . $delimiter . 'bank_account_mandat.bic' . $delimiter . ',iban as ' . $delimiter . 'bank_account_mandat.iban' . $delimiter . ',city as ' . $delimiter . 'bank_account_mandat.city' . $delimiter . ',zip as ' . $delimiter . 'bank_account_mandat.zip' . $delimiter . ',address as ' . $delimiter . 'bank_account_mandat.address' . $delimiter . ',lastname as ' . $delimiter . 'bank_account_mandat.lastname' . $delimiter . ',firstname as ' . $delimiter . 'bank_account_mandat.firstname' . $delimiter . ',issuedate as ' . $delimiter . 'bank_account_mandat.issuedate' . $delimiter . ',signaturedate as ' . $delimiter . 'bank_account_mandat.signaturedate' . $delimiter . ',mandatsreferenzno as ' . $delimiter . 'bank_account_mandat.mandatsreferenzno' . $delimiter . ',id_bank_account as ' . $delimiter . 'bank_account_mandat.id_bank_account' . $delimiter . ',id as ' . $delimiter . 'bank_account_mandat.id' . $delimiter . ' from bank_account_mandat';
}
