...
{
	return array('wid','uid','type','message','variables','severity','link','location','referer','hostname','timestamp','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select wid as ' . $delimiter . 'drupal_watchdog.wid' . $delimiter . ',uid as ' . $delimiter . 'drupal_watchdog.uid' . $delimiter . ',type as ' . $delimiter . 'drupal_watchdog.type' . $delimiter . ',message as ' . $delimiter . 'drupal_watchdog.message' . $delimiter . ',variables as ' . $delimiter . 'drupal_watchdog.variables' . $delimiter . ',severity as ' . $delimiter . 'drupal_watchdog.severity' . $delimiter . ',link as ' . $delimiter . 'drupal_watchdog.link' . $delimiter . ',location as ' . $delimiter . 'drupal_watchdog.location' . $delimiter . ',referer as ' . $delimiter . 'drupal_watchdog.referer' . $delimiter . ',hostname as ' . $delimiter . 'drupal_watchdog.hostname' . $delimiter . ',timestamp as ' . $delimiter . 'drupal_watchdog.timestamp' . $delimiter . ',id as ' . $delimiter . 'drupal_watchdog.id' . $delimiter . ' from drupal_watchdog';
}
