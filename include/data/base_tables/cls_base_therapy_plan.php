...
{
	return array('valid_til','valid_from','create_date','id_person_employee_created','id_person','id_therapy_plan_template','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select valid_til as ' . $delimiter . 'therapy_plan.valid_til' . $delimiter . ',valid_from as ' . $delimiter . 'therapy_plan.valid_from' . $delimiter . ',create_date as ' . $delimiter . 'therapy_plan.create_date' . $delimiter . ',id_person_employee_created as ' . $delimiter . 'therapy_plan.id_person_employee_created' . $delimiter . ',id_person as ' . $delimiter . 'therapy_plan.id_person' . $delimiter . ',id_therapy_plan_template as ' . $delimiter . 'therapy_plan.id_therapy_plan_template' . $delimiter . ',id as ' . $delimiter . 'therapy_plan.id' . $delimiter . ' from therapy_plan';
}
