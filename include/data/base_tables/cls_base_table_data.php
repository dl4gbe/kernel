...
{
	return array('id_data_view_default','config_table','id_table_search_template','searchable','create_history','use_orm','static_data','location_independant','table_name','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select id_data_view_default as ' . $delimiter . 'table_data.id_data_view_default' . $delimiter . ',config_table as ' . $delimiter . 'table_data.config_table' . $delimiter . ',id_table_search_template as ' . $delimiter . 'table_data.id_table_search_template' . $delimiter . ',searchable as ' . $delimiter . 'table_data.searchable' . $delimiter . ',create_history as ' . $delimiter . 'table_data.create_history' . $delimiter . ',use_orm as ' . $delimiter . 'table_data.use_orm' . $delimiter . ',static_data as ' . $delimiter . 'table_data.static_data' . $delimiter . ',location_independant as ' . $delimiter . 'table_data.location_independant' . $delimiter . ',table_name as ' . $delimiter . 'table_data.table_name' . $delimiter . ',id as ' . $delimiter . 'table_data.id' . $delimiter . ' from table_data';
}
