...
{
	return array('id','bankcode','bic','pan','name','id_person');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'bank.id' . $delimiter . ',bankcode as ' . $delimiter . 'bank.bankcode' . $delimiter . ',bic as ' . $delimiter . 'bank.bic' . $delimiter . ',pan as ' . $delimiter . 'bank.pan' . $delimiter . ',name as ' . $delimiter . 'bank.name' . $delimiter . ',id_person as ' . $delimiter . 'bank.id_person' . $delimiter . ' from bank';
}
