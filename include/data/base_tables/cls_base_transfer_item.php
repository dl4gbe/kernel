...
{
	return array('amount','id_bank_account','id_posting_header_storno','no','id_posting_header','id_transfer','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select amount as ' . $delimiter . 'transfer_item.amount' . $delimiter . ',id_bank_account as ' . $delimiter . 'transfer_item.id_bank_account' . $delimiter . ',id_posting_header_storno as ' . $delimiter . 'transfer_item.id_posting_header_storno' . $delimiter . ',no as ' . $delimiter . 'transfer_item.no' . $delimiter . ',id_posting_header as ' . $delimiter . 'transfer_item.id_posting_header' . $delimiter . ',id_transfer as ' . $delimiter . 'transfer_item.id_transfer' . $delimiter . ',id as ' . $delimiter . 'transfer_item.id' . $delimiter . ' from transfer_item';
}
