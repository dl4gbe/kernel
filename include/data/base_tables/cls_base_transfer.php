...
{
	return array('remark','defaultrun','id_person_storno','stornodate','id_bank_account','typ','rundate','id_person_employee','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select remark as ' . $delimiter . 'transfer.remark' . $delimiter . ',defaultrun as ' . $delimiter . 'transfer.defaultrun' . $delimiter . ',id_person_storno as ' . $delimiter . 'transfer.id_person_storno' . $delimiter . ',stornodate as ' . $delimiter . 'transfer.stornodate' . $delimiter . ',id_bank_account as ' . $delimiter . 'transfer.id_bank_account' . $delimiter . ',typ as ' . $delimiter . 'transfer.typ' . $delimiter . ',rundate as ' . $delimiter . 'transfer.rundate' . $delimiter . ',id_person_employee as ' . $delimiter . 'transfer.id_person_employee' . $delimiter . ',id as ' . $delimiter . 'transfer.id' . $delimiter . ' from transfer';
}
