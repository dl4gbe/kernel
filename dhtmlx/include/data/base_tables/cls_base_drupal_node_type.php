...
{
	return array('type','name','base','module','description','help','has_title','title_label','custom','modified','locked','disabled','orig_type','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select type as ' . $delimiter . 'drupal_node_type.type' . $delimiter . ',name as ' . $delimiter . 'drupal_node_type.name' . $delimiter . ',base as ' . $delimiter . 'drupal_node_type.base' . $delimiter . ',module as ' . $delimiter . 'drupal_node_type.module' . $delimiter . ',description as ' . $delimiter . 'drupal_node_type.description' . $delimiter . ',help as ' . $delimiter . 'drupal_node_type.help' . $delimiter . ',has_title as ' . $delimiter . 'drupal_node_type.has_title' . $delimiter . ',title_label as ' . $delimiter . 'drupal_node_type.title_label' . $delimiter . ',custom as ' . $delimiter . 'drupal_node_type.custom' . $delimiter . ',modified as ' . $delimiter . 'drupal_node_type.modified' . $delimiter . ',locked as ' . $delimiter . 'drupal_node_type.locked' . $delimiter . ',disabled as ' . $delimiter . 'drupal_node_type.disabled' . $delimiter . ',orig_type as ' . $delimiter . 'drupal_node_type.orig_type' . $delimiter . ',id as ' . $delimiter . 'drupal_node_type.id' . $delimiter . ' from drupal_node_type';
}
