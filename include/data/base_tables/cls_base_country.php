...
{
	return array('open_geo_db_id','id_chart_of_account_default','currency','sepa','ibanlength','display','orderno','countrycode','nationality','name','alpha3','alpha2','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select open_geo_db_id as ' . $delimiter . 'country.open_geo_db_id' . $delimiter . ',id_chart_of_account_default as ' . $delimiter . 'country.id_chart_of_account_default' . $delimiter . ',currency as ' . $delimiter . 'country.currency' . $delimiter . ',sepa as ' . $delimiter . 'country.sepa' . $delimiter . ',ibanlength as ' . $delimiter . 'country.ibanlength' . $delimiter . ',display as ' . $delimiter . 'country.display' . $delimiter . ',orderno as ' . $delimiter . 'country.orderno' . $delimiter . ',countrycode as ' . $delimiter . 'country.countrycode' . $delimiter . ',nationality as ' . $delimiter . 'country.nationality' . $delimiter . ',name as ' . $delimiter . 'country.name' . $delimiter . ',alpha3 as ' . $delimiter . 'country.alpha3' . $delimiter . ',alpha2 as ' . $delimiter . 'country.alpha2' . $delimiter . ',id as ' . $delimiter . 'country.id' . $delimiter . ' from country';
}
