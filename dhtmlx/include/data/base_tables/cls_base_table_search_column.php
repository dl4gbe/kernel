...
{
	return array('id','table_name','table_column_name','activ','case_sensitive');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'table_search_column.id' . $delimiter . ',table_name as ' . $delimiter . 'table_search_column.table_name' . $delimiter . ',table_column_name as ' . $delimiter . 'table_search_column.table_column_name' . $delimiter . ',activ as ' . $delimiter . 'table_search_column.activ' . $delimiter . ',case_sensitive as ' . $delimiter . 'table_search_column.case_sensitive' . $delimiter . ' from table_search_column';
}
