...
{
	return array('profitandlostaccount','balancesheetaccount','accounttil','accountfrom','name','no','id_chart_of_account','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select profitandlostaccount as ' . $delimiter . 'account_group.profitandlostaccount' . $delimiter . ',balancesheetaccount as ' . $delimiter . 'account_group.balancesheetaccount' . $delimiter . ',accounttil as ' . $delimiter . 'account_group.accounttil' . $delimiter . ',accountfrom as ' . $delimiter . 'account_group.accountfrom' . $delimiter . ',name as ' . $delimiter . 'account_group.name' . $delimiter . ',no as ' . $delimiter . 'account_group.no' . $delimiter . ',id_chart_of_account as ' . $delimiter . 'account_group.id_chart_of_account' . $delimiter . ',id as ' . $delimiter . 'account_group.id' . $delimiter . ' from account_group';
}
