...
{
	return array('person_states_code','id_communication_reason_type','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select person_states_code as ' . $delimiter . 'communication_reason_type_person_state.person_states_code' . $delimiter . ',id_communication_reason_type as ' . $delimiter . 'communication_reason_type_person_state.id_communication_reason_type' . $delimiter . ',id as ' . $delimiter . 'communication_reason_type_person_state.id' . $delimiter . ' from communication_reason_type_person_state';
}
