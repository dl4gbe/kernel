...
{
	return array('id_insurance_district','onlyfornewprescriptions','price','validfrom','id_article','id_insurance_group','id_insurance','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select id_insurance_district as ' . $delimiter . 'insurance_price.id_insurance_district' . $delimiter . ',onlyfornewprescriptions as ' . $delimiter . 'insurance_price.onlyfornewprescriptions' . $delimiter . ',price as ' . $delimiter . 'insurance_price.price' . $delimiter . ',validfrom as ' . $delimiter . 'insurance_price.validfrom' . $delimiter . ',id_article as ' . $delimiter . 'insurance_price.id_article' . $delimiter . ',id_insurance_group as ' . $delimiter . 'insurance_price.id_insurance_group' . $delimiter . ',id_insurance as ' . $delimiter . 'insurance_price.id_insurance' . $delimiter . ',id as ' . $delimiter . 'insurance_price.id' . $delimiter . ' from insurance_price';
}
