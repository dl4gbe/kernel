...
{
	return array('date_type_until','valid_until','date_type_since','valid_since','int_val','int_type','loc_id');
}

public function get_table_select($delimiter = '"')
{
	return 'select date_type_until as ' . $delimiter . 'geodb_intdata.date_type_until' . $delimiter . ',valid_until as ' . $delimiter . 'geodb_intdata.valid_until' . $delimiter . ',date_type_since as ' . $delimiter . 'geodb_intdata.date_type_since' . $delimiter . ',valid_since as ' . $delimiter . 'geodb_intdata.valid_since' . $delimiter . ',int_val as ' . $delimiter . 'geodb_intdata.int_val' . $delimiter . ',int_type as ' . $delimiter . 'geodb_intdata.int_type' . $delimiter . ',loc_id as ' . $delimiter . 'geodb_intdata.loc_id' . $delimiter . ' from geodb_intdata';
}
