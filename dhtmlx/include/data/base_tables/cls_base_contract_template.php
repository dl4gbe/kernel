...
{
	return array('id','name','active','maxsales','id_contract_template_group','calcdifferenceamount');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'contract_template.id' . $delimiter . ',name as ' . $delimiter . 'contract_template.name' . $delimiter . ',active as ' . $delimiter . 'contract_template.active' . $delimiter . ',maxsales as ' . $delimiter . 'contract_template.maxsales' . $delimiter . ',id_contract_template_group as ' . $delimiter . 'contract_template.id_contract_template_group' . $delimiter . ',calcdifferenceamount as ' . $delimiter . 'contract_template.calcdifferenceamount' . $delimiter . ' from contract_template';
}
