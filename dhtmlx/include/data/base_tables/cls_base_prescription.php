...
{
	return array('id','id_person','ik','insurance_name','id_insurance','memberno','memberstate','positionnumber1','positionsnumber2','maxunits_applied','maxunitsperweek_applied','maxmonths_applied','maxunits_issued','maxunitsperweek_issued','maxmonths_issued','lanr','betrno','validfrom','validtil','insurance_approval_date','physician_applicatiom_date','patient_signature_date','startdate','issuedate','id_prescription_type','diagnosis','damage','goal','id_sport');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'prescription.id' . $delimiter . ',id_person as ' . $delimiter . 'prescription.id_person' . $delimiter . ',ik as ' . $delimiter . 'prescription.ik' . $delimiter . ',insurance_name as ' . $delimiter . 'prescription.insurance_name' . $delimiter . ',id_insurance as ' . $delimiter . 'prescription.id_insurance' . $delimiter . ',memberno as ' . $delimiter . 'prescription.memberno' . $delimiter . ',memberstate as ' . $delimiter . 'prescription.memberstate' . $delimiter . ',positionnumber1 as ' . $delimiter . 'prescription.positionnumber1' . $delimiter . ',positionsnumber2 as ' . $delimiter . 'prescription.positionsnumber2' . $delimiter . ',maxunits_applied as ' . $delimiter . 'prescription.maxunits_applied' . $delimiter . ',maxunitsperweek_applied as ' . $delimiter . 'prescription.maxunitsperweek_applied' . $delimiter . ',maxmonths_applied as ' . $delimiter . 'prescription.maxmonths_applied' . $delimiter . ',maxunits_issued as ' . $delimiter . 'prescription.maxunits_issued' . $delimiter . ',maxunitsperweek_issued as ' . $delimiter . 'prescription.maxunitsperweek_issued' . $delimiter . ',maxmonths_issued as ' . $delimiter . 'prescription.maxmonths_issued' . $delimiter . ',lanr as ' . $delimiter . 'prescription.lanr' . $delimiter . ',betrno as ' . $delimiter . 'prescription.betrno' . $delimiter . ',validfrom as ' . $delimiter . 'prescription.validfrom' . $delimiter . ',validtil as ' . $delimiter . 'prescription.validtil' . $delimiter . ',insurance_approval_date as ' . $delimiter . 'prescription.insurance_approval_date' . $delimiter . ',physician_applicatiom_date as ' . $delimiter . 'prescription.physician_applicatiom_date' . $delimiter . ',patient_signature_date as ' . $delimiter . 'prescription.patient_signature_date' . $delimiter . ',startdate as ' . $delimiter . 'prescription.startdate' . $delimiter . ',issuedate as ' . $delimiter . 'prescription.issuedate' . $delimiter . ',id_prescription_type as ' . $delimiter . 'prescription.id_prescription_type' . $delimiter . ',diagnosis as ' . $delimiter . 'prescription.diagnosis' . $delimiter . ',damage as ' . $delimiter . 'prescription.damage' . $delimiter . ',goal as ' . $delimiter . 'prescription.goal' . $delimiter . ',id_sport as ' . $delimiter . 'prescription.id_sport' . $delimiter . ' from prescription';
}
