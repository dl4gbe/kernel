...
{
	return array('id','id_person','id_desease','id_offer_event','state','id_person_employee','issuedate','quarter','remark');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'person_desease.id' . $delimiter . ',id_person as ' . $delimiter . 'person_desease.id_person' . $delimiter . ',id_desease as ' . $delimiter . 'person_desease.id_desease' . $delimiter . ',id_offer_event as ' . $delimiter . 'person_desease.id_offer_event' . $delimiter . ',state as ' . $delimiter . 'person_desease.state' . $delimiter . ',id_person_employee as ' . $delimiter . 'person_desease.id_person_employee' . $delimiter . ',issuedate as ' . $delimiter . 'person_desease.issuedate' . $delimiter . ',quarter as ' . $delimiter . 'person_desease.quarter' . $delimiter . ',remark as ' . $delimiter . 'person_desease.remark' . $delimiter . ' from person_desease';
}
