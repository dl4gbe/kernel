...
{
	return array('active','name','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select active as ' . $delimiter . 'chart_of_account.active' . $delimiter . ',name as ' . $delimiter . 'chart_of_account.name' . $delimiter . ',id as ' . $delimiter . 'chart_of_account.id' . $delimiter . ' from chart_of_account';
}
