...
{
	return array('nid','gid','realm','grant_view','grant_update','grant_delete','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select nid as ' . $delimiter . 'drupal_node_access.nid' . $delimiter . ',gid as ' . $delimiter . 'drupal_node_access.gid' . $delimiter . ',realm as ' . $delimiter . 'drupal_node_access.realm' . $delimiter . ',grant_view as ' . $delimiter . 'drupal_node_access.grant_view' . $delimiter . ',grant_update as ' . $delimiter . 'drupal_node_access.grant_update' . $delimiter . ',grant_delete as ' . $delimiter . 'drupal_node_access.grant_delete' . $delimiter . ',id as ' . $delimiter . 'drupal_node_access.id' . $delimiter . ' from drupal_node_access';
}
