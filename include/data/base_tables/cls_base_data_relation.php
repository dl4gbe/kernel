...
{
	return array('active','remark','id_data_relation_type_vals','id_data2','id_data1','id_data_relation_type','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select active as ' . $delimiter . 'data_relation.active' . $delimiter . ',remark as ' . $delimiter . 'data_relation.remark' . $delimiter . ',id_data_relation_type_vals as ' . $delimiter . 'data_relation.id_data_relation_type_vals' . $delimiter . ',id_data2 as ' . $delimiter . 'data_relation.id_data2' . $delimiter . ',id_data1 as ' . $delimiter . 'data_relation.id_data1' . $delimiter . ',id_data_relation_type as ' . $delimiter . 'data_relation.id_data_relation_type' . $delimiter . ',id as ' . $delimiter . 'data_relation.id' . $delimiter . ' from data_relation';
}
