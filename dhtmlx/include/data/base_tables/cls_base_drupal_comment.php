...
{
	return array('cid','pid','nid','uid','subject','hostname','created','changed','status','thread','name','mail','homepage','language','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select cid as ' . $delimiter . 'drupal_comment.cid' . $delimiter . ',pid as ' . $delimiter . 'drupal_comment.pid' . $delimiter . ',nid as ' . $delimiter . 'drupal_comment.nid' . $delimiter . ',uid as ' . $delimiter . 'drupal_comment.uid' . $delimiter . ',subject as ' . $delimiter . 'drupal_comment.subject' . $delimiter . ',hostname as ' . $delimiter . 'drupal_comment.hostname' . $delimiter . ',created as ' . $delimiter . 'drupal_comment.created' . $delimiter . ',changed as ' . $delimiter . 'drupal_comment.changed' . $delimiter . ',status as ' . $delimiter . 'drupal_comment.status' . $delimiter . ',thread as ' . $delimiter . 'drupal_comment.thread' . $delimiter . ',name as ' . $delimiter . 'drupal_comment.name' . $delimiter . ',mail as ' . $delimiter . 'drupal_comment.mail' . $delimiter . ',homepage as ' . $delimiter . 'drupal_comment.homepage' . $delimiter . ',language as ' . $delimiter . 'drupal_comment.language' . $delimiter . ',id as ' . $delimiter . 'drupal_comment.id' . $delimiter . ' from drupal_comment';
}
