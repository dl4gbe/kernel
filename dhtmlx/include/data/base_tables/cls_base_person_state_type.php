...
{
	return 'select id as ' . $delimiter . 'person_state_type.id' . $delimiter . ',id_person_states_group as ' . $delimiter . 'person_state_type.id_person_states_group' . $delimiter . ',name as ' . $delimiter . 'person_state_type.name' . $delimiter . ',id_article_price_group as ' . $delimiter . 'person_state_type.id_article_price_group' . $delimiter . ',id_contract_template as ' . $delimiter . 'person_state_type.id_contract_template' . $delimiter . ' from person_state_type';
}
