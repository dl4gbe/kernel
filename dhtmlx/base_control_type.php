...
require_once('table_helpers/cls_base_control_type_helpers.php');
$app = new cls_application();
$get_parameter = new cls_get_parameter();
$helper = new cls_base_control_type_helpers($app->get_db_manager(),$app);
	...
	switch ($mode)
		{
			...
			case "sql_create":
				...
				return $orm->create_table_sql_statement("base_control_type",$get_parameter->database_type);
				break;
		}
	exit;
}
