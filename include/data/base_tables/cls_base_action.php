...
{
	return array('key','name','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select key as ' . $delimiter . 'action.key' . $delimiter . ',name as ' . $delimiter . 'action.name' . $delimiter . ',id as ' . $delimiter . 'action.id' . $delimiter . ' from action';
}
