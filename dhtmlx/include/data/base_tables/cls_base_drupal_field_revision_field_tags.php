...
{
	return 'select entity_type as ' . $delimiter . 'drupal_field_revision_field_tags.entity_type' . $delimiter . ',bundle as ' . $delimiter . 'drupal_field_revision_field_tags.bundle' . $delimiter . ',deleted as ' . $delimiter . 'drupal_field_revision_field_tags.deleted' . $delimiter . ',entity_id as ' . $delimiter . 'drupal_field_revision_field_tags.entity_id' . $delimiter . ',revision_id as ' . $delimiter . 'drupal_field_revision_field_tags.revision_id' . $delimiter . ',language as ' . $delimiter . 'drupal_field_revision_field_tags.language' . $delimiter . ',delta as ' . $delimiter . 'drupal_field_revision_field_tags.delta' . $delimiter . ',field_tags_tid as ' . $delimiter . 'drupal_field_revision_field_tags.field_tags_tid' . $delimiter . ',id as ' . $delimiter . 'drupal_field_revision_field_tags.id' . $delimiter . ' from drupal_field_revision_field_tags';
}
