...
{
	return array('id','name','no','id_offertype','positionnumber','validfrom','validtil','id_person_employee');
}

public function get_table_select($delimiter = '"')
{
	return 'select id as ' . $delimiter . 'offer.id' . $delimiter . ',name as ' . $delimiter . 'offer.name' . $delimiter . ',no as ' . $delimiter . 'offer.no' . $delimiter . ',id_offertype as ' . $delimiter . 'offer.id_offertype' . $delimiter . ',positionnumber as ' . $delimiter . 'offer.positionnumber' . $delimiter . ',validfrom as ' . $delimiter . 'offer.validfrom' . $delimiter . ',validtil as ' . $delimiter . 'offer.validtil' . $delimiter . ',id_person_employee as ' . $delimiter . 'offer.id_person_employee' . $delimiter . ' from offer';
}
