...
{
	return array('discount','active','name','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select discount as ' . $delimiter . 'article_price_group.discount' . $delimiter . ',active as ' . $delimiter . 'article_price_group.active' . $delimiter . ',name as ' . $delimiter . 'article_price_group.name' . $delimiter . ',id as ' . $delimiter . 'article_price_group.id' . $delimiter . ' from article_price_group';
}
