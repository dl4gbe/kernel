...
{
	return array('paymentsduringrestperiod','paymentcycle','paymentinterval','freeunitsperyear','freeunitspermonth','freeunitsperweek','freeunitsperday','increaseperyear','increasepermonth','amountperyear','amountpermonth','amountperweek','amountperday','extensioninmonth','durationinmonths','paydow','payday','id_contract_template_pos','id_article','extendable','cancelrequestreceived','paymentstart','enddate','paymenttype','maincontract','startdate','id_contract','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select paymentsduringrestperiod as ' . $delimiter . 'contract_pos.paymentsduringrestperiod' . $delimiter . ',paymentcycle as ' . $delimiter . 'contract_pos.paymentcycle' . $delimiter . ',paymentinterval as ' . $delimiter . 'contract_pos.paymentinterval' . $delimiter . ',freeunitsperyear as ' . $delimiter . 'contract_pos.freeunitsperyear' . $delimiter . ',freeunitspermonth as ' . $delimiter . 'contract_pos.freeunitspermonth' . $delimiter . ',freeunitsperweek as ' . $delimiter . 'contract_pos.freeunitsperweek' . $delimiter . ',freeunitsperday as ' . $delimiter . 'contract_pos.freeunitsperday' . $delimiter . ',increaseperyear as ' . $delimiter . 'contract_pos.increaseperyear' . $delimiter . ',increasepermonth as ' . $delimiter . 'contract_pos.increasepermonth' . $delimiter . ',amountperyear as ' . $delimiter . 'contract_pos.amountperyear' . $delimiter . ',amountpermonth as ' . $delimiter . 'contract_pos.amountpermonth' . $delimiter . ',amountperweek as ' . $delimiter . 'contract_pos.amountperweek' . $delimiter . ',amountperday as ' . $delimiter . 'contract_pos.amountperday' . $delimiter . ',extensioninmonth as ' . $delimiter . 'contract_pos.extensioninmonth' . $delimiter . ',durationinmonths as ' . $delimiter . 'contract_pos.durationinmonths' . $delimiter . ',paydow as ' . $delimiter . 'contract_pos.paydow' . $delimiter . ',payday as ' . $delimiter . 'contract_pos.payday' . $delimiter . ',id_contract_template_pos as ' . $delimiter . 'contract_pos.id_contract_template_pos' . $delimiter . ',id_article as ' . $delimiter . 'contract_pos.id_article' . $delimiter . ',extendable as ' . $delimiter . 'contract_pos.extendable' . $delimiter . ',cancelrequestreceived as ' . $delimiter . 'contract_pos.cancelrequestreceived' . $delimiter . ',paymentstart as ' . $delimiter . 'contract_pos.paymentstart' . $delimiter . ',enddate as ' . $delimiter . 'contract_pos.enddate' . $delimiter . ',paymenttype as ' . $delimiter . 'contract_pos.paymenttype' . $delimiter . ',maincontract as ' . $delimiter . 'contract_pos.maincontract' . $delimiter . ',startdate as ' . $delimiter . 'contract_pos.startdate' . $delimiter . ',id_contract as ' . $delimiter . 'contract_pos.id_contract' . $delimiter . ',id as ' . $delimiter . 'contract_pos.id' . $delimiter . ' from contract_pos';
}
