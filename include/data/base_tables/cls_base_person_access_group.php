...
{
	return array('id_person','id_access_group','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select id_person as ' . $delimiter . 'person_access_group.id_person' . $delimiter . ',id_access_group as ' . $delimiter . 'person_access_group.id_access_group' . $delimiter . ',id as ' . $delimiter . 'person_access_group.id' . $delimiter . ' from person_access_group';
}
