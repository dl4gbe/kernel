...
{
	return array('uid','name','pass','mail','theme','signature','signature_format','created','access','login','status','timezone','language','picture','init','data','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select uid as ' . $delimiter . 'drupal_users.uid' . $delimiter . ',name as ' . $delimiter . 'drupal_users.name' . $delimiter . ',pass as ' . $delimiter . 'drupal_users.pass' . $delimiter . ',mail as ' . $delimiter . 'drupal_users.mail' . $delimiter . ',theme as ' . $delimiter . 'drupal_users.theme' . $delimiter . ',signature as ' . $delimiter . 'drupal_users.signature' . $delimiter . ',signature_format as ' . $delimiter . 'drupal_users.signature_format' . $delimiter . ',created as ' . $delimiter . 'drupal_users.created' . $delimiter . ',access as ' . $delimiter . 'drupal_users.access' . $delimiter . ',login as ' . $delimiter . 'drupal_users.login' . $delimiter . ',status as ' . $delimiter . 'drupal_users.status' . $delimiter . ',timezone as ' . $delimiter . 'drupal_users.timezone' . $delimiter . ',language as ' . $delimiter . 'drupal_users.language' . $delimiter . ',picture as ' . $delimiter . 'drupal_users.picture' . $delimiter . ',init as ' . $delimiter . 'drupal_users.init' . $delimiter . ',data as ' . $delimiter . 'drupal_users.data' . $delimiter . ',id as ' . $delimiter . 'drupal_users.id' . $delimiter . ' from drupal_users';
}
