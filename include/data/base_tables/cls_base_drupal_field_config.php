...
{
	return array('deleted','translatable','cardinality','data','locked','storage_active','storage_module','storage_type','active','module','type','field_name','id');
}

public function get_table_select($delimiter = '"')
{
	return 'select deleted as ' . $delimiter . 'drupal_field_config.deleted' . $delimiter . ',translatable as ' . $delimiter . 'drupal_field_config.translatable' . $delimiter . ',cardinality as ' . $delimiter . 'drupal_field_config.cardinality' . $delimiter . ',data as ' . $delimiter . 'drupal_field_config.data' . $delimiter . ',locked as ' . $delimiter . 'drupal_field_config.locked' . $delimiter . ',storage_active as ' . $delimiter . 'drupal_field_config.storage_active' . $delimiter . ',storage_module as ' . $delimiter . 'drupal_field_config.storage_module' . $delimiter . ',storage_type as ' . $delimiter . 'drupal_field_config.storage_type' . $delimiter . ',active as ' . $delimiter . 'drupal_field_config.active' . $delimiter . ',module as ' . $delimiter . 'drupal_field_config.module' . $delimiter . ',type as ' . $delimiter . 'drupal_field_config.type' . $delimiter . ',field_name as ' . $delimiter . 'drupal_field_config.field_name' . $delimiter . ',id as ' . $delimiter . 'drupal_field_config.id' . $delimiter . ' from drupal_field_config';
}
