...
abstract class cls_base_table_test_test_item extends cls_datatable_base
{
...
{
	return 'select id as ' . $delimiter . 'table_test_test_item.id' . $delimiter . ',tablename as ' . $delimiter . 'table_test_test_item.tablename' . $delimiter . ',name as ' . $delimiter . 'table_test_test_item.name' . $delimiter . ',path as ' . $delimiter . 'table_test_test_item.path' . $delimiter . ',source as ' . $delimiter . 'table_test_test_item.source' . $delimiter . ' from table_test_test_item';
}
...
public function save($db_manager,$application)
	{
		require_once('include/data/base_table_savers/cls_save_table_test_test_item.php');
		return cls_save_table_test_test_item::save_object($this,$db_manager,$application);
	}

public function save_array($data,$db_manager,$application)
	{
		require_once('include/data/base_table_savers/cls_save_table_test_test_item.php');
		return cls_save_table_test_test_item::save_array($data,$db_manager,$application);
	}
