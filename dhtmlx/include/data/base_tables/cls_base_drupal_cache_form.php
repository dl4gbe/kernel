...
{
	return 'select cid as ' . $delimiter . 'drupal_cache_form.cid' . $delimiter . ',data as ' . $delimiter . 'drupal_cache_form.data' . $delimiter . ',expire as ' . $delimiter . 'drupal_cache_form.expire' . $delimiter . ',created as ' . $delimiter . 'drupal_cache_form.created' . $delimiter . ',serialized as ' . $delimiter . 'drupal_cache_form.serialized' . $delimiter . ',id as ' . $delimiter . 'drupal_cache_form.id' . $delimiter . ' from drupal_cache_form';
}
